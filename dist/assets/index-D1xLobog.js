(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))a(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const o of n.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&a(o)}).observe(document,{childList:!0,subtree:!0});function s(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function a(r){if(r.ep)return;r.ep=!0;const n=s(r);fetch(r.href,n)}})();const R=[{value:"code-vibes",label:"Code vibes theme"},{value:"foods",label:"Foods theme"}],A=[{value:"blue",label:"Blue"},{value:"orange",label:"Orange"}],P=[{value:"16",label:"16 cards"},{value:"24",label:"24 cards"},{value:"36",label:"36 cards"}];let i={boardSize:null,player:null,theme:null};function l(){return{...i}}function G(e){i={...i,theme:e}}function z(e){i={...i,player:e}}function N(e){i={...i,boardSize:e}}function C(){return!!(i.theme&&i.player&&i.boardSize)}function j(e){return R.some(t=>t.value===e)}function q(e){return A.some(t=>t.value===e)}function V(e){return P.some(t=>t.value===e)}let d=null;function U(e){d={...e}}function K(){return d?{...d}:null}function W(){return d!==null}function Y(){d=null}const X="/projects/memory/assets/Code%20vibes%20theme_16-DnDZKwbK.svg",J="/projects/memory/assets/Code%20vibes%20theme_24-B6WV80WL.svg",Q="/projects/memory/assets/Code%20vibes%20theme_36-DBGuI9rU.svg",e2="/projects/memory/assets/Food_theme_16-C22FWGub.svg",t2="/projects/memory/assets/Food_theme_24-CMaMg8km.svg",s2="/projects/memory/assets/Food_theme_36-DpVdfDWc.svg",a2="code-vibes",r2={"code-vibes":{boardImages:{16:X,24:J,36:Q},cssModifierClass:"game-screen--code-vibes"},foods:{boardImages:{16:e2,24:t2,36:s2},cssModifierClass:"game-screen--foods"}};function n2(e){return e??a2}function o2(e){return r2[n2(e)].cssModifierClass}const H=`<svg width="10" height="8" viewBox="0 0 10 8" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,c2="/projects/memory/assets/exitgame1-BZslv4aI.svg",i2="/projects/memory/assets/Cards%205-DZnpmrpx.svg",l2="/projects/memory/assets/angular-card-CMiTHiGh.svg",d2="/projects/memory/assets/bootstrap-card-Rq83vZTa.svg",u2="/projects/memory/assets/css-card-Yna33ZIc.svg",m2="/projects/memory/assets/database-card-DZJGMO6r.svg",p2="/projects/memory/assets/django-card-zdDnWkPj.svg",C2="/projects/memory/assets/firebase-card-BGJGDkPQ.svg",g2="/projects/memory/assets/guthub-card-C0OAhCwn.svg",f2="/projects/memory/assets/html5-card-CuL2MCMe.svg",h2="/projects/memory/assets/js-card-vn5hBh96.svg",v2="/projects/memory/assets/node-card-Dum8zyHj.svg",_2="/projects/memory/assets/python-card-xA_4epsW.svg",y2="/projects/memory/assets/react-card-CIELOEMr.svg",b2="/projects/memory/assets/sass-card-DwnRYj6b.svg",w2="/projects/memory/assets/terminal-card-B7_Z2NcV.svg",S2="/projects/memory/assets/ts-card-BKPozS6g.svg",L2="/projects/memory/assets/vscode-card-fF042ORC.svg",E2="/projects/memory/assets/vue-card-BoB3VO2b.svg",B=[l2,d2,u2,m2,p2,C2,g2,f2,h2,v2,_2,y2,b2,w2,S2,L2,E2];function B2(e){const t=o2(e.theme),s=e.boardSize??"16",a=x2(s),r=$2(s),n=e.theme!=="foods",o=e.player==="orange"?" is-orange":" is-blue";return`
  ...
  `}function $2(e){const t=Number.parseInt(e,10),s=Number.isFinite(t)&&t>0?t:16,a=Math.floor(s/2),r=k2(a);return M2([...r,...r]).map((o,c)=>`
    ...
    `).join("")}function k2(e){return Array.from({length:e},(t,s)=>B[s%B.length])}function M2(e){const t=[...e];for(let s=t.length-1;s>0;s-=1){const a=Math.floor(Math.random()*(s+1));[t[s],t[a]]=[t[a],t[s]]}return t}function x2(e){return e==="24"?"game-screen--board-24":e==="36"?"game-screen--board-36":"game-screen--board-16"}const F2="#game-exit-button",R2=".game-card",A2="[data-current-player-marker]",m="flipped",p="is-matched",P2=700;function j2(e){const t=l();e.innerHTML=B2(t),H2(e),Z2(e,t.player??"blue")}function H2(e){const t=e.querySelector(F2);t&&t.addEventListener("click",()=>{window.location.hash="#settings"})}function Z2(e,t){const s=Array.from(e.querySelectorAll(R2));if(s.length===0)return;const a={currentPlayer:t,firstFlippedCard:null,secondFlippedCard:null,isTurnLocked:!1,scores:{blue:0,orange:0}};w(e,a),s.forEach(r=>{r.addEventListener("click",()=>{D2(e,s.length,a,r)})})}function D2(e,t,s,a){if(s.isTurnLocked||a.classList.contains(m)||a.classList.contains(p))return;if(g(a),!s.firstFlippedCard){s.firstFlippedCard=a;return}if(s.secondFlippedCard=a,s.isTurnLocked=!0,G2(s.firstFlippedCard,s.secondFlippedCard)){z2(e,t,s);return}window.setTimeout(()=>{s.firstFlippedCard&&s.firstFlippedCard.classList.contains(m)&&g(s.firstFlippedCard),s.secondFlippedCard&&s.secondFlippedCard.classList.contains(m)&&g(s.secondFlippedCard),s.currentPlayer=s.currentPlayer==="blue"?"orange":"blue",b(s),w(e,s)},P2)}function g(e){e.classList.toggle(m)}function G2(e,t){const s=e.dataset.cardIcon,a=t.dataset.cardIcon;return!!(s&&a&&s===a)}function z2(e,t,s){const a=s.firstFlippedCard,r=s.secondFlippedCard;if(!a||!r){b(s);return}a.classList.add(p),r.classList.add(p),a.disabled=!0,r.disabled=!0,s.scores[s.currentPlayer]+=1,b(s),w(e,s),e.querySelectorAll(`.${p}`).length===t&&(U({blueScore:s.scores.blue,orangeScore:s.scores.orange}),window.location.hash="#game-over")}function b(e){e.firstFlippedCard=null,e.secondFlippedCard=null,e.isTurnLocked=!1}function w(e,t){I(e,"blue",t.scores.blue),I(e,"orange",t.scores.orange);const s=e.querySelector(A2);s&&s.classList.toggle("is-orange",t.currentPlayer==="orange")}function I(e,t,s){const a=e.querySelectorAll(`[data-score-player="${t}"]`);a.length!==0&&a.forEach(r=>{r.textContent=String(s)})}function N2(e){const t=q2();return`
  ...
  `}function l0(e){return R.map(t=>S("theme",t.value,t.label,e===t.value)).join("")}function d0(e){return A.map(t=>S("player",t.value,t.label,e===t.value)).join("")}function u0(e){return P.map(t=>S("boardSize",t.value,t.label,e===t.value)).join("")}function S(e,t,s,a){const r=a?" is-selected":"",n=a?" is-visible":"",o=a?$:T,c=e==="theme"?` data-preview-theme="${t}"`:"";return`
