(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))n(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function s(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerPolicy&&(r.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?r.credentials="include":a.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(a){if(a.ep)return;a.ep=!0;const r=s(a);fetch(a.href,r)}})();const $=[{value:"code-vibes",label:"Code vibes theme"},{value:"foods",label:"Foods theme"}],O=[{value:"blue",label:"Blue"},{value:"orange",label:"Orange"}],T=[{value:"16",label:"16 cards"},{value:"24",label:"24 cards"},{value:"36",label:"36 cards"}];let i={boardSize:null,player:null,theme:null};function l(){return{...i}}function I(e){i={...i,theme:e}}function P(e){i={...i,player:e}}function A(e){i={...i,boardSize:e}}function f(){return!!(i.theme&&i.player&&i.boardSize)}function x(e){return $.some(t=>t.value===e)}function H(e){return O.some(t=>t.value===e)}function R(e){return T.some(t=>t.value===e)}const Z="/projects/memory/assets/Code%20vibes%20theme_16-DnDZKwbK.svg",F="/projects/memory/assets/Code%20vibes%20theme_24-B6WV80WL.svg",z="/projects/memory/assets/Code%20vibes%20theme_36-DBGuI9rU.svg",N="/projects/memory/assets/Food_theme_16-C22FWGub.svg",j="/projects/memory/assets/Food_theme_24-CMaMg8km.svg",D="/projects/memory/assets/Food_theme_36-DpVdfDWc.svg",q="code-vibes",G={"code-vibes":{boardImages:{16:Z,24:F,36:z},cssModifierClass:"game-screen--code-vibes"},foods:{boardImages:{16:N,24:j,36:D},cssModifierClass:"game-screen--foods"}};function U(e){return e??q}function V(e){return G[U(e)].cssModifierClass}const K=`<svg width="10" height="8" viewBox="0 0 10 8" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,W="/projects/memory/assets/exitgame1-BZslv4aI.svg",X="/projects/memory/assets/Cards%205-DZnpmrpx.svg";function Y(e){const t=V(e.theme),s=e.boardSize??"16",n=s2(s),a=t2(s),r=e.theme!=="foods",o=e.player==="orange"?" is-orange":" is-blue";return`
      ...
      <div class="game-screen__canvas">
        <section class="game-screen__board-area" aria-label="Game board">
          <div
            ...
            id="game-board"
            data-board-size="${s}"
            style="--game-card-back-image: url('${X}')"
          >
            ${a}
          </div>
        </section>
  ...
  `}function Q(){return K.replace(/fill="#2BB1FF"/gi,'fill="currentColor"').trim()}function e2(){return`
    <div class="game-screen__hud">
      <button
        id="game-exit-button"
  ...
  `}function t2(e){const t=Number.parseInt(e,10);return Array.from({length:t},(s,n)=>`
    ...
    `).join("")}function s2(e){return e==="24"?"game-screen--board-24":e==="36"?"game-screen--board-36":"game-screen--board-16"}const a2="#game-exit-button";function n2(e){e.innerHTML=Y(l()),r2(e)}function r2(e){const t=e.querySelector(a2);t&&t.addEventListener("click",()=>{window.location.hash="#settings"})}const o2="/projects/memory/assets/stadia_controller-CcsXEKot.svg",y="/projects/memory/assets/play-button-CNXT5xaq.svg";function i2(){return`
    ...
    <main class="settings-screen" aria-labelledby="settings-title">
      <div class="settings-screen__canvas">
        <section class="settings-panel">
          ...
          ${u("Game themes",f2,w2(e.theme))}
          ${u("Choose player",h2,S2(e.player))}
          ${u("Board size",g2,E2(e.boardSize))}
        </section>
  ...
  `}function w2(e){return $.map(t=>h("theme",t.value,t.label,e===t.value)).join("")}function S2(e){return O.map(t=>h("player",t.value,t.label,e===t.value)).join("")}function E2(e){return T.map(t=>h("boardSize",t.value,t.label,e===t.value)).join("")}function h(e,t,s,n){const a=n?" is-selected":"",r=n?" is-visible":"",o=n?w:b,c=e==="theme"?` data-preview-theme="${t}"`:"";return`
  ...
  `}function L2(e,t){return`
    <div class="settings-footer__summary" aria-live="polite">
      <div class="settings-footer__fields">
        ...
        ${C("player",$2(e.player),e.player!==null,!0)}
  ...
  `}function B2(e){return e?"Game theme":"Theme"}function $2(e){return e?e==="orange"?"Orange Player":"Blue Player":"Player"}function O2(e){return e?`Board-${e} Cards`:"Board size"}function T2(e){return`
    <button
  ...
  `}const k=".settings-option",x2='.settings-option[data-group="theme"]',k2=".settings-option__line",M2=".settings-option__marker",I2=".settings-footer__separator",P2=".settings-preview__image",M="#start-game-button",p="is-refreshing";function A2(e){e.innerHTML=b2(l()),H2(e),z2(e),W2(e),m(e,l().theme)}function H2(e){e.querySelectorAll(k).forEach(s=>{s.addEventListener("click",()=>{R2(e,s.dataset.group,s.dataset.value)})})}function R2(e,t,s){!t||!s||(Z2(t,s),F2(e,l()))}function Z2(e,t){if(e==="theme"&&x(t)){I(t);return}if(e==="player"&&H(t)){P(t);return}e==="boardSize"&&R(t)&&A(t)}function F2(e,t){N2(e,t),D2(e,t),K2(e),m(e,t.theme)}function z2(e){e.querySelectorAll(x2).forEach(s=>{s.addEventListener("mouseenter",()=>{L(e,s.dataset.previewTheme)}),s.addEventListener("mouseleave",()=>{m(e,l().theme)}),s.addEventListener("focus",()=>{L(e,s.dataset.previewTheme)}),s.addEventListener("blur",()=>{m(e,l().theme)})})}function L(e,t){!t||!x(t)||m(e,t)}function m(e,t){const s=e.querySelector(P2);if(!s)return;const n=t==="foods"?s.dataset.previewFoods:s.dataset.previewCodeVibes||s.dataset.previewDefault;n&&(s.src=n)}function N2(e,t){e.querySelectorAll(k).forEach(n=>{const a=j2(t,n.dataset.group,n.dataset.value);n.classList.toggle("is-selected",a),n.querySelector(k2)?.classList.toggle("is-visible",a);const o=n.querySelector(M2);if(!o)return;const c=a?o.dataset.activeIcon:o.dataset.inactiveIcon;c&&(o.src=c)})}function j2(e,t,s){return!t||!s?!1:t==="theme"?e.theme===s:t==="player"?e.player===s:t==="boardSize"?e.boardSize===s:!1}function D2(e,t){g(e,"theme",t.theme!==null,G2(t.theme)),g(e,"player",t.player!==null,U2(t.player)),g(e,"boardSize",t.boardSize!==null,V2(t.boardSize))}function g(e,t,s,n){const a=e.querySelector(`[data-summary-group="${t}"]`);if(!a)return;const r=a.classList.contains("is-selected");a.classList.toggle("is-selected",s);const o=a.querySelector(I2);if(o){const _=s?o.dataset.separatorActive:o.dataset.separatorInactive;_&&(o.src=_)}const c=a.querySelector(`[data-summary-text="${t}"]`);let v=!1;c&&c.textContent!==n&&(c.textContent=n,v=!0),(s&&!r||v)&&q2(a)}function q2(e){e.classList.remove(p),window.requestAnimationFrame(()=>{e.classList.add(p),window.setTimeout(()=>{e.classList.remove(p)},240)})}function G2(e){return e?"Game theme":"Theme"}function U2(e){return e?e==="orange"?"Orange Player":"Blue Player":"Player"}function V2(e){return e?`Board-${e} Cards`:"Board size"}function K2(e){const t=e.querySelector(M);if(!t)return;const s=f();t.classList.toggle("is-ready",s),t.disabled=!s}function W2(e){const t=e.querySelector(M);t&&t.addEventListener("click",()=>{f()&&(window.location.hash="#game")})}function X2(e){B(e),window.addEventListener("hashchange",()=>{B(e)})}function B(e){const t=J2();if(t==="home"){u2(e);return}if(t==="settings"){A2(e);return}Y2(e)}function Y2(e){if(!f()){window.location.hash="#settings";return}n2(e)}function J2(){const e=window.location.hash.toLowerCase();return e==="#settings"?"settings":e==="#game"?"game":"home"}function Q2(){const e=document.getElementById("app");e&&X2(e)}Q2();
