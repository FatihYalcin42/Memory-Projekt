...
`,i2="/projects/memory/assets/exitgame1-BZslv4aI.svg",j="/projects/memory/assets/back-to-game-button-Dy28tT7r.svg",l2="/projects/memory/assets/exit-game-button-CSFmJePI.svg",m2="/projects/memory/assets/exit-game-button-DxiUlG8b.svg",_2="/projects/memory/assets/exit-game-button-hover-CWKYXIiz.svg",d2="/projects/memory/assets/back-to-game-button-BckwOnvC.svg",u2="/projects/memory/assets/back-to-game-button-hover-CltZJA0Z.svg",C2="/projects/memory/assets/exit-game-button-overlay-BmTcSkCT.svg",g2="/projects/memory/assets/exit-game-button-overlay-hover-CHeUaH3n.svg",E2="/projects/memory/assets/Cards%205-DZnpmrpx.svg",p2="/projects/memory/assets/angular-card-CMiTHiGh.svg",f2="/projects/memory/assets/bootstrap-card-Rq83vZTa.svg",S2="/projects/memory/assets/css-card-Yna33ZIc.svg",R2="/projects/memory/assets/database-card-DZJGMO6r.svg",O2="/projects/memory/assets/django-card-zdDnWkPj.svg",A2="/projects/memory/assets/firebase-card-BGJGDkPQ.svg",v2="/projects/memory/assets/guthub-card-C0OAhCwn.svg",h2="/projects/memory/assets/html5-card-CuL2MCMe.svg",T2="/projects/memory/assets/js-card-vn5hBh96.svg",y2="/projects/memory/assets/node-card-Dum8zyHj.svg",b2="/projects/memory/assets/python-card-xA_4epsW.svg",I2="/projects/memory/assets/react-card-CIELOEMr.svg",L2="/projects/memory/assets/sass-card-DwnRYj6b.svg",M2="/projects/memory/assets/terminal-card-B7_Z2NcV.svg",B2="/projects/memory/assets/ts-card-BKPozS6g.svg",P2="/projects/memory/assets/vscode-card-fF042ORC.svg",N2="/projects/memory/assets/vue-card-BoB3VO2b.svg",w2="/projects/memory/assets/back-card-D-qRVjX3.svg",x2="/projects/memory/assets/brezel-card-CXqqkZs-.svg",D2="/projects/memory/assets/cake-card-BXMN5G8t.svg",U2="/projects/memory/assets/chicken-card-V3orblRE.svg",k2="/projects/memory/assets/chocolate-card-QAzOvrHx.svg",F2="/projects/memory/assets/corndog-card-CwpjZjE3.svg",G2="/projects/memory/assets/donut-card-C0Ssqpoo.svg",H2="/projects/memory/assets/hamburger-card-CjV68Ggw.svg",V2="/projects/memory/assets/icecream-card-CoO_ylkx.svg",Y2="/projects/memory/assets/macron-card-D9lMrSKW.svg",j2="/projects/memory/assets/muffin-card-DO8Rb5nk.svg",K2="/projects/memory/assets/pizza-card-CCl09bmZ.svg",W2="/projects/memory/assets/pommes-card-KiUYGabn.svg",Z2="/projects/memory/assets/pudding-card-Ct1M7kVT.svg",X2="/projects/memory/assets/salad-card-8HQ_A0VA.svg",z2="/projects/memory/assets/sandwich-card-Z1FA70DW.svg",q2="/projects/memory/assets/sushi-card-DUXi4ArE.svg",$2="/projects/memory/assets/tacco-card-D5AQdy9w.svg",J2="/projects/memory/assets/wrao-card-CLUKRYIs.svg",Q2=`<main class="game-screen {{GAME_THEME_CLASS_NAME}} {{BOARD_SIZE_CLASS_NAME}}" aria-labelledby="game-title">
...
`,m=`<!-- Reusable game-over fragments -->
...
`,r0=c(m,"game-over-confetti"),s0=c(m,"game-over-winner-code-vibes"),o0=c(m,"game-over-winner-foods"),c0=c(m,"game-over-winner-player-icon-foods"),i0=c(m,"game-over-summary-foods"),l0=c(m,"game-over-summary-code-vibes"),m0=c(m,"game-over-summary-foods-row"),_0=c(m,"game-over-summary-code-vibes-row");function d0(e,n){const t=A(n),a=t==="foods",r=T0(e),s=R0(e,t);return o(a0,{BACK_HOME_BUTTON_IMAGE_CLASS_NAME:h0(a),BACK_HOME_BUTTON_SRC:v0(a),CONFETTI_MARKUP:a?"":C0(),SCORE_SUMMARY_MARKUP:s,THEME_CLASS_NAME:a?"game-over-screen--foods":"game-over-screen--code-vibes",WINNER_CONTENT_MARKUP:u0(r,a,s)})}function u0(e,n,t){return n?E0(e):g0(e,t)}function C0(){return o(r0,{CONFETTI_SRC:Qe})}function g0(e,n){return o(s0,{SCORE_SUMMARY_MARKUP:n,WINNER_LABEL:e.label,WINNER_PLAYER_CLASS_NAME:e.className,WINNER_PREFIX_MARKUP:e.isDraw?"":'<p class="game-over-screen__winner-prefix">the winner is</p>'})}function E0(e){return o(o0,{PLAYER_ICON_MARKUP:p0(e),WINNER_LABEL:e.label,WINNER_PLAYER_CLASS_NAME:e.className,WINNER_PREFIX_MARKUP:e.isDraw?"":'<p class="game-over-screen__winner-prefix">The winner is</p>'})}function p0(e){if(e.isDraw)return"";const n=e.className==="game-over-screen__winner-player--orange";return o(c0,{WINNER_ICON_ALT:n?"Orange player icon":"Blue player icon",WINNER_ICON_SRC:n?t0:n0})}function f0(){return Y.replace(/fill="#2BB1FF"/gi,'fill="currentColor"').trim()}function S0(){return v.replace(/fill="#097FC5"/gi,'fill="currentColor"').trim()}function R0(e,n){return n==="foods"?O0(e):A0(e)}function O0(e){const n=S0();return o(i0,{FOODS_BLUE_SCORE_ROW:P("blue",e.blueScore,n),FOODS_ORANGE_SCORE_ROW:P("orange",e.orangeScore,n)})}function P(e,n,t){return o(m0,{PLAYER_COLOR:e,PLAYER_LABEL_ICON:t,PLAYER_SCORE:String(n)})}function A0(e){const n=f0();return o(l0,{CODE_VIBES_BLUE_SCORE_ROW:N("blue","Blue",e.blueScore,n),CODE_VIBES_ORANGE_SCORE_ROW:N("orange","Orange",e.orangeScore,n)})}function N(e,n,t,a){return o(_0,{PLAYER_COLOR:e,PLAYER_LABEL_ICON:a,PLAYER_NAME:n,PLAYER_SCORE:String(t)})}function v0(e){return e?e0:j}function h0(e){return e?"game-over-screen__back-home-button-image game-over-screen__back-home-button-image--foods":"game-over-screen__back-home-button-image"}function T0(e){return e.blueScore>e.orangeScore?{isDraw:!1,className:"game-over-screen__winner-player--blue",label:"BLUE PLAYER"}:e.orangeScore>e.blueScore?{isDraw:!1,className:"game-over-screen__winner-player--orange",label:"ORANGE PLAYER"}:{isDraw:!0,className:"game-over-screen__winner-player--draw",label:"DRAW"}}const y0=3500,b0="[data-game-over-screen]",I0="[data-back-home-button]",L0="is-winner-visible";function M0(e){const n=a2();if(!n){window.location.hash="#game";return}e.innerHTML=d0(n,_().theme),B0(e),P0(e)}function B0(e){e.querySelector(I0)?.addEventListener("click",()=>{V(),window.location.hash="#home"})}function P0(e){const n=e.querySelector(b0);n&&window.setTimeout(()=>{N0(e,n)},y0)}function N0(e,n){!e.isConnected||window.location.hash!=="#game-over"||n.classList.add(L0)}const w0="/projects/memory/assets/stadia_controller-CcsXEKot.svg",x0="/projects/memory/assets/play-button-CNXT5xaq.svg",D0=`<main class="home-screen" aria-labelledby="home-title">
...
`,q0=c(d,"settings-group"),$0=c(d,"settings-option-button"),J0=c(d,"settings-footer-summary"),Q0=c(d,"settings-footer-item"),en=c(d,"settings-footer-separator"),nn=c(d,"settings-start-button");function tn(e){const n=e.theme!==null&&e.player!==null&&e.boardSize!==null,t=e.theme==="foods"?D:p;return o(z0,{BOARD_SIZE_GROUP_MARKUP:f("Board size",V0,sn(e.boardSize)),FOOTER_SUMMARY_MARKUP:on(e,n),PLAYER_GROUP_MARKUP:f("Choose player",j0,rn(e.player)),PREVIEW_CODE_VIBES_SRC:p,PREVIEW_DEFAULT_SRC:p,PREVIEW_FOODS_SRC:D,PREVIEW_IMAGE_SRC:t,THEME_GROUP_MARKUP:f("Game themes",Y0,an(e.theme))})}function f(e,n,t){return o(q0,{GROUP_ICON_SRC:n,GROUP_TITLE:e,OPTIONS_MARKUP:t})}function an(e){return k.map(n=>b("theme",n.value,n.label,e===n.value)).join("")}function rn(e){return F.map(n=>b("player",n.value,n.label,e===n.value)).join("")}function sn(e){return G.map(n=>b("boardSize",n.value,n.label,e===n.value)).join("")}function b(e,n,t,a){const r=e==="theme"?` data-preview-theme="${n}"`:"";return o($0,{MARKER_ACTIVE_ICON_SRC:x,MARKER_ICON_SRC:a?x:w,MARKER_INACTIVE_ICON_SRC:w,OPTION_GROUP:e,OPTION_LABEL:t,OPTION_VALUE:n,PREVIEW_THEME_ATTRIBUTE:r,SELECTED_CLASS:a?" is-selected":"",SELECTED_LINE_ICON_SRC:Z0,VISIBLE_LINE_CLASS:a?" is-visible":""})}function on(e,n){return o(J0,{FOOTER_FIELDS_MARKUP:cn(e),START_BUTTON_MARKUP:un(n)})}function cn(e){return[S("theme",mn(e.theme),e.theme!==null,!0),S("player",_n(e.player),e.player!==null,!0),S("boardSize",dn(e.boardSize),e.boardSize!==null,!1)].join("")}function S(e,n,t,a){return o(Q0,{SELECTED_CLASS:t?" is-selected":"",SEPARATOR_MARKUP:a?ln():"",SUMMARY_GROUP:e,SUMMARY_TEXT:n})}function ln(){return o(en,{SEPARATOR_ACTIVE_SRC:K0,SEPARATOR_LINE_SRC:W0})}function mn(e){return e?"Game theme":"Theme"}function _n(e){return e?e==="orange"?"Orange Player":"Blue Player":"Player"}function dn(e){return e?`Board-${e} Cards`:"Board size"}function un(e){return o(nn,{DISABLED_ATTRIBUTE:e?"":" disabled",READY_CLASS:e?" is-ready":"",START_BUTTON_IMAGE_SRC:X0})}const Z=".settings-option",Cn='.settings-option[data-group="theme"]',gn=".settings-option__line",En=".settings-option__marker",pn=".settings-footer__separator",fn=".settings-preview__image",X="#start-game-button",R="is-refreshing";function Sn(e){e.innerHTML=tn(_()),Rn(e),In(e),qn(e),E(e,_().theme)}function Rn(e){e.querySelectorAll(Z).forEach(t=>{t.addEventListener("click",()=>{On(e,t.dataset.group,t.dataset.value)})})}function On(e,n,t){!n||!t||(An(n,t),bn(e,_()))}function An(e,n){const t=vn(e);t&&t(n)}function vn(e){return e==="theme"?hn:e==="player"?Tn:e==="boardSize"?yn:null}function hn(e){H(e)&&$(e)}function Tn(e){e2(e)&&J(e)}function yn(e){n2(e)&&Q(e)}function bn(e,n){Bn(e,n),Un(e,n),zn(e),E(e,n.theme)}function In(e){e.querySelectorAll(Cn).forEach(t=>{Ln(e,t)})}function Ln(e,n){const t=()=>Mn(e,n.dataset.previewTheme),a=()=>E(e,_().theme);n.addEventListener("mouseenter",t),n.addEventListener("mouseleave",a),n.addEventListener("focus",t),n.addEventListener("blur",a)}function Mn(e,n){!n||!H(n)||E(e,n)}function E(e,n){const t=e.querySelector(fn);if(!t)return;const a=n==="foods"?t.dataset.previewFoods:t.dataset.previewCodeVibes||t.dataset.previewDefault;a&&(t.src=a)}function Bn(e,n){e.querySelectorAll(Z).forEach(a=>{Pn(a,n)})}function Pn(e,n){const t=xn(n,e.dataset.group,e.dataset.value);e.classList.toggle("is-selected",t),Nn(e,t),wn(e,t)}function Nn(e,n){e.querySelector(gn)?.classList.toggle("is-visible",n)}function wn(e,n){const t=e.querySelector(En);if(!t)return;const a=n?t.dataset.activeIcon:t.dataset.inactiveIcon;a&&(t.src=a)}function xn(e,n,t){return!n||!t?!1:Dn(e,n)===t}function Dn(e,n){return n==="theme"?e.theme:n==="player"?e.player:n==="boardSize"?e.boardSize:null}function Un(e,n){kn(n).forEach(([a,r,s])=>{Fn(e,a,r,s)})}function kn(e){return[["theme",e.theme!==null,Wn(e.theme)],["player",e.player!==null,Zn(e.player)],["boardSize",e.boardSize!==null,Xn(e.boardSize)]]}function Fn(e,n,t,a){const r=e.querySelector(`[data-summary-group="${n}"]`);if(!r)return;const s=Gn(r,t);Hn(r,t);const i=Yn(r,n,a);jn(t,s,i)&&Kn(r)}function Gn(e,n){const t=e.classList.contains("is-selected");return e.classList.toggle("is-selected",n),t}function Hn(e,n){const t=e.querySelector(pn),a=Vn(t,n);t&&a&&(t.src=a)}function Vn(e,n){if(e)return n?e.dataset.separatorActive:e.dataset.separatorInactive}function Yn(e,n,t){const a=e.querySelector(`[data-summary-text="${n}"]`);return!a||a.textContent===t?!1:(a.textContent=t,!0)}function jn(e,n,t){return e&&!n||t}function Kn(e){e.classList.remove(R),window.requestAnimationFrame(()=>{e.classList.add(R),window.setTimeout(()=>{e.classList.remove(R)},240)})}function Wn(e){return e?"Game theme":"Theme"}function Zn(e){return e?e==="orange"?"Orange Player":"Blue Player":"Player"}function Xn(e){return e?`Board-${e} Cards`:"Board size"}function zn(e){const n=e.querySelector(X);if(!n)return;const t=g();n.classList.toggle("is-ready",t),n.disabled=!t}function qn(e){const n=e.querySelector(X);n&&n.addEventListener("click",$n)}function $n(){g()&&(V(),window.location.hash="#game")}function Jn(e){U(e),window.addEventListener("hashchange",()=>{U(e)})}function U(e){const n=nt(),t=at[n];t(e)}function Qn(e){if(!g()){window.location.hash="#settings";return}Me(e)}function et(e){if(!g()){window.location.hash="#settings";return}if(!r2()){window.location.hash="#game";return}M0(e)}function nt(){const e=window.location.hash.toLowerCase();return tt[e]??"home"}const tt={"#game":"game","#game-over":"game-over","#home":"home","#settings":"settings"},at={game:Qn,"game-over":et,home:F0,settings:Sn};function rt(){const e=document.getElementById("app");e&&Jn(e)}rt();
