(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))a(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const o of n.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&a(o)}).observe(document,{childList:!0,subtree:!0});function s(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function a(r){if(r.ep)return;r.ep=!0;const n=s(r);fetch(r.href,n)}})();const A=[{value:"code-vibes",label:"Code vibes theme"},{value:"foods",label:"Foods theme"}],F=[{value:"blue",label:"Blue"},{value:"orange",label:"Orange"}],P=[{value:"16",label:"16 cards"},{value:"24",label:"24 cards"},{value:"36",label:"36 cards"}];let i={boardSize:null,player:null,theme:null};function l(){return{...i}}function G(e){i={...i,theme:e}}function z(e){i={...i,player:e}}function N(e){i={...i,boardSize:e}}function C(){return!!(i.theme&&i.player&&i.boardSize)}function j(e){return A.some(t=>t.value===e)}function q(e){return F.some(t=>t.value===e)}function V(e){return P.some(t=>t.value===e)}let d=null;function U(e){d={...e}}function K(){return d?{...d}:null}function W(){return d!==null}function Y(){d=null}const X="/projects/memory/assets/Code%20vibes%20theme_16-DnDZKwbK.svg",J="/projects/memory/assets/Code%20vibes%20theme_24-B6WV80WL.svg",Q="/projects/memory/assets/Code%20vibes%20theme_36-DBGuI9rU.svg",e2="/projects/memory/assets/Food_theme_16-C22FWGub.svg",t2="/projects/memory/assets/Food_theme_24-CMaMg8km.svg",s2="/projects/memory/assets/Food_theme_36-DpVdfDWc.svg",a2="code-vibes",r2={"code-vibes":{boardImages:{16:X,24:J,36:Q},cssModifierClass:"game-screen--code-vibes"},foods:{boardImages:{16:e2,24:t2,36:s2},cssModifierClass:"game-screen--foods"}};function n2(e){return e??a2}function o2(e){return r2[n2(e)].cssModifierClass}const H=`<svg width="10" height="8" viewBox="0 0 10 8" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,c2="/projects/memory/assets/exitgame1-BZslv4aI.svg",i2="/projects/memory/assets/Cards%205-DZnpmrpx.svg",l2="/projects/memory/assets/angular-card-CMiTHiGh.svg",d2="/projects/memory/assets/bootstrap-card-Rq83vZTa.svg",u2="/projects/memory/assets/css-card-Yna33ZIc.svg",m2="/projects/memory/assets/database-card-DZJGMO6r.svg",p2="/projects/memory/assets/django-card-zdDnWkPj.svg",C2="/projects/memory/assets/firebase-card-BGJGDkPQ.svg",g2="/projects/memory/assets/guthub-card-C0OAhCwn.svg",f2="/projects/memory/assets/html5-card-CuL2MCMe.svg",h2="/projects/memory/assets/js-card-vn5hBh96.svg",v2="/projects/memory/assets/node-card-Dum8zyHj.svg",_2="/projects/memory/assets/python-card-xA_4epsW.svg",y2="/projects/memory/assets/react-card-CIELOEMr.svg",b2="/projects/memory/assets/sass-card-DwnRYj6b.svg",w2="/projects/memory/assets/terminal-card-B7_Z2NcV.svg",S2="/projects/memory/assets/ts-card-BKPozS6g.svg",L2="/projects/memory/assets/vscode-card-fF042ORC.svg",E2="/projects/memory/assets/vue-card-BoB3VO2b.svg",B=[l2,d2,u2,m2,p2,C2,g2,f2,h2,v2,_2,y2,b2,w2,S2,L2,E2];function B2(e){const t=o2(e.theme),s=e.boardSize??"16",a=x2(s),r=$2(s),n=e.theme!=="foods",o=e.player==="orange"?" is-orange":" is-blue";return`
  ...
  `}function $2(e){const t=Number.parseInt(e,10),s=Number.isFinite(t)&&t>0?t:16,a=Math.floor(s/2),r=k2(a);return M2([...r,...r]).map((o,c)=>`
    ...
    `).join("")}function k2(e){return Array.from({length:e},(t,s)=>B[s%B.length])}function M2(e){const t=[...e];for(let s=t.length-1;s>0;s-=1){const a=Math.floor(Math.random()*(s+1));[t[s],t[a]]=[t[a],t[s]]}return t}function x2(e){return e==="24"?"game-screen--board-24":e==="36"?"game-screen--board-36":"game-screen--board-16"}const R2="#game-exit-button",A2=".game-card",F2="[data-current-player-marker]",m="flipped",p="is-matched",P2=700;function j2(e){const t=l();e.innerHTML=B2(t),H2(e),Z2(e,t.player??"blue")}function H2(e){const t=e.querySelector(R2);t&&t.addEventListener("click",()=>{window.location.hash="#settings"})}function Z2(e,t){const s=Array.from(e.querySelectorAll(A2));if(s.length===0)return;const a={currentPlayer:t,firstFlippedCard:null,secondFlippedCard:null,isTurnLocked:!1,scores:{blue:0,orange:0}};w(e,a),s.forEach(r=>{r.addEventListener("click",()=>{D2(e,s.length,a,r)})})}function D2(e,t,s,a){if(s.isTurnLocked||a.classList.contains(m)||a.classList.contains(p))return;if(g(a),!s.firstFlippedCard){s.firstFlippedCard=a;return}if(s.secondFlippedCard=a,s.isTurnLocked=!0,G2(s.firstFlippedCard,s.secondFlippedCard)){z2(e,t,s);return}window.setTimeout(()=>{s.firstFlippedCard&&s.firstFlippedCard.classList.contains(m)&&g(s.firstFlippedCard),s.secondFlippedCard&&s.secondFlippedCard.classList.contains(m)&&g(s.secondFlippedCard),s.currentPlayer=s.currentPlayer==="blue"?"orange":"blue",b(s),w(e,s)},P2)}function g(e){e.classList.toggle(m)}function G2(e,t){const s=e.dataset.cardIcon,a=t.dataset.cardIcon;return!!(s&&a&&s===a)}function z2(e,t,s){const a=s.firstFlippedCard,r=s.secondFlippedCard;if(!a||!r){b(s);return}a.classList.add(p),r.classList.add(p),a.disabled=!0,r.disabled=!0,s.scores[s.currentPlayer]+=1,b(s),w(e,s),e.querySelectorAll(`.${p}`).length===t&&(U({blueScore:s.scores.blue,orangeScore:s.scores.orange}),window.location.hash="#game-over")}function b(e){e.firstFlippedCard=null,e.secondFlippedCard=null,e.isTurnLocked=!1}function w(e,t){I(e,"blue",t.scores.blue),I(e,"orange",t.scores.orange);const s=e.querySelector(F2);s&&s.classList.toggle("is-orange",t.currentPlayer==="orange")}function I(e,t,s){const a=e.querySelectorAll(`[data-score-player="${t}"]`);a.length!==0&&a.forEach(r=>{r.textContent=String(s)})}function N2(e){const t=q2();return`
  ...
  `}function q2(){return H.replace(/fill="#2BB1FF"/gi,'fill="currentColor"').trim()}function V2(e){const t=K();if(!t){window.location.hash="#game";return}e.innerHTML=N2(t)}const U2="/projects/memory/assets/stadia_controller-CcsXEKot.svg",O="/projects/memory/assets/play-button-CNXT5xaq.svg";function K2(){return`
    ...
    <main class="settings-screen" aria-labelledby="settings-title">
      <div class="settings-screen__canvas">
        <section class="settings-panel">
          ...
          ${h("Game themes",a0,l0(e.theme))}
          ${h("Choose player",r0,d0(e.player))}
          ${h("Board size",s0,u0(e.boardSize))}
        </section>
  ...
  `}function l0(e){return A.map(t=>S("theme",t.value,t.label,e===t.value)).join("")}function d0(e){return F.map(t=>S("player",t.value,t.label,e===t.value)).join("")}function u0(e){return P.map(t=>S("boardSize",t.value,t.label,e===t.value)).join("")}function S(e,t,s,a){const r=a?" is-selected":"",n=a?" is-visible":"",o=a?$:T,c=e==="theme"?` data-preview-theme="${t}"`:"";return`
  ...
  `}function m0(e,t){return`
    <div class="settings-footer__summary" aria-live="polite">
      <div class="settings-footer__fields">
        ...
        ${v("player",C0(e.player),e.player!==null,!0)}
        ${v("boardSize",g0(e.boardSize),e.boardSize!==null,!1)}
      </div>
      ${f0(t)}
    </div>
  ...
  `}function p0(e){return e?"Game theme":"Theme"}function C0(e){return e?e==="orange"?"Orange Player":"Blue Player":"Player"}function g0(e){return e?`Board-${e} Cards`:"Board size"}function f0(e){return`
    <button
  ...
  `}const Z=".settings-option",h0='.settings-option[data-group="theme"]',v0=".settings-option__line",_0=".settings-option__marker",y0=".settings-footer__separator",b0=".settings-preview__image",D="#start-game-button",_="is-refreshing";function w0(e){e.innerHTML=i0(l()),S0(e),I0(e),F0(e),u(e,l().theme)}function S0(e){e.querySelectorAll(Z).forEach(s=>{s.addEventListener("click",()=>{L0(e,s.dataset.group,s.dataset.value)})})}function L0(e,t,s){!t||!s||(E0(t,s),B0(e,l()))}function E0(e,t){if(e==="theme"&&j(t)){G(t);return}if(e==="player"&&q(t)){z(t);return}e==="boardSize"&&V(t)&&N(t)}function B0(e,t){O0(e,t),$0(e,t),A0(e),u(e,t.theme)}function I0(e){e.querySelectorAll(h0).forEach(s=>{s.addEventListener("mouseenter",()=>{x(e,s.dataset.previewTheme)}),s.addEventListener("mouseleave",()=>{u(e,l().theme)}),s.addEventListener("focus",()=>{x(e,s.dataset.previewTheme)}),s.addEventListener("blur",()=>{u(e,l().theme)})})}function x(e,t){!t||!j(t)||u(e,t)}function u(e,t){const s=e.querySelector(b0);if(!s)return;const a=t==="foods"?s.dataset.previewFoods:s.dataset.previewCodeVibes||s.dataset.previewDefault;a&&(s.src=a)}function O0(e,t){e.querySelectorAll(Z).forEach(a=>{const r=T0(t,a.dataset.group,a.dataset.value);a.classList.toggle("is-selected",r),a.querySelector(v0)?.classList.toggle("is-visible",r);const o=a.querySelector(_0);if(!o)return;const c=r?o.dataset.activeIcon:o.dataset.inactiveIcon;c&&(o.src=c)})}function T0(e,t,s){return!t||!s?!1:t==="theme"?e.theme===s:t==="player"?e.player===s:t==="boardSize"?e.boardSize===s:!1}function $0(e,t){y(e,"theme",t.theme!==null,M0(t.theme)),y(e,"player",t.player!==null,x0(t.player)),y(e,"boardSize",t.boardSize!==null,R0(t.boardSize))}function y(e,t,s,a){const r=e.querySelector(`[data-summary-group="${t}"]`);if(!r)return;const n=r.classList.contains("is-selected");r.classList.toggle("is-selected",s);const o=r.querySelector(y0);if(o){const E=s?o.dataset.separatorActive:o.dataset.separatorInactive;E&&(o.src=E)}const c=r.querySelector(`[data-summary-text="${t}"]`);let L=!1;c&&c.textContent!==a&&(c.textContent=a,L=!0),(s&&!n||L)&&k0(r)}function k0(e){e.classList.remove(_),window.requestAnimationFrame(()=>{e.classList.add(_),window.setTimeout(()=>{e.classList.remove(_)},240)})}function M0(e){return e?"Game theme":"Theme"}function x0(e){return e?e==="orange"?"Orange Player":"Blue Player":"Player"}function R0(e){return e?`Board-${e} Cards`:"Board size"}function A0(e){const t=e.querySelector(D);if(!t)return;const s=C();t.classList.toggle("is-ready",s),t.disabled=!s}function F0(e){const t=e.querySelector(D);t&&t.addEventListener("click",()=>{C()&&(Y(),window.location.hash="#game")})}function P0(e){R(e),window.addEventListener("hashchange",()=>{R(e)})}function R(e){const t=Z0();if(t==="home"){Q2(e);return}if(t==="settings"){w0(e);return}if(t==="game-over"){H0(e);return}j0(e)}function j0(e){if(!C()){window.location.hash="#settings";return}j2(e)}function H0(e){if(!C()){window.location.hash="#settings";return}if(!W()){window.location.hash="#game";return}V2(e)}function Z0(){const e=window.location.hash.toLowerCase();return e==="#settings"?"settings":e==="#game"?"game":e==="#game-over"?"game-over":"home"}function D0(){const e=document.getElementById("app");e&&P0(e)}D0();
