(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))n(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function s(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerPolicy&&(r.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?r.credentials="include":a.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(a){if(a.ep)return;a.ep=!0;const r=s(a);fetch(a.href,r)}})();const O=[{value:"code-vibes",label:"Code vibes theme"},{value:"foods",label:"Foods theme"}],T=[{value:"blue",label:"Blue"},{value:"orange",label:"Orange"}],$=[{value:"16",label:"16 cards"},{value:"24",label:"24 cards"},{value:"36",label:"36 cards"}];let i={boardSize:null,player:null,theme:null};function l(){return{...i}}function P(e){i={...i,theme:e}}function H(e){i={...i,player:e}}function R(e){i={...i,boardSize:e}}function g(){return!!(i.theme&&i.player&&i.boardSize)}function x(e){return O.some(t=>t.value===e)}function Z(e){return T.some(t=>t.value===e)}function z(e){return $.some(t=>t.value===e)}const F="/projects/memory/assets/Code%20vibes%20theme_16-DnDZKwbK.svg",N="/projects/memory/assets/Code%20vibes%20theme_24-B6WV80WL.svg",D="/projects/memory/assets/Code%20vibes%20theme_36-DBGuI9rU.svg",U="/projects/memory/assets/Food_theme_16-C22FWGub.svg",V="/projects/memory/assets/Food_theme_24-CMaMg8km.svg",q="/projects/memory/assets/Food_theme_36-DpVdfDWc.svg",j="code-vibes",G="16",k={"code-vibes":{boardImages:{16:F,24:N,36:D},cssModifierClass:"game-screen--code-vibes"},foods:{boardImages:{16:U,24:V,36:q},cssModifierClass:"game-screen--foods"}};function M(e){return e??j}function K(e){return e??G}function W(e){return k[M(e)].cssModifierClass}function X(e,t){const s=M(e),n=K(t);return k[s].boardImages[n]}const Y="data:image/svg+xml,%3csvg%20width='10'%20height='8'%20viewBox='0%200%2010%208'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M1.02564%208C0.74359%208%200.502137%207.90208%200.301282%207.70625C0.100427%207.51042%200%207.275%200%207V1C0%200.725%200.100427%200.489583%200.301282%200.29375C0.502137%200.0979167%200.74359%200%201.02564%200H6.66667C6.82906%200%206.98291%200.0354167%207.12821%200.10625C7.27351%200.177083%207.39316%200.275%207.48718%200.4L9.79487%203.4C9.93162%203.575%2010%203.775%2010%204C10%204.225%209.93162%204.425%209.79487%204.6L7.48718%207.6C7.39316%207.725%207.27351%207.82292%207.12821%207.89375C6.98291%207.96458%206.82906%208%206.66667%208H1.02564Z'%20fill='%232BB1FF'/%3e%3c/svg%3e",J="/projects/memory/assets/exit-game-button-VOUV_rTh.svg";function Q(e){const t=W(e.theme),s=s2(e),n=X(e.theme,e.boardSize),a=e.theme!=="foods",r=e.player==="orange"?" is-orange":" is-blue";return`
  ...
  `}function s2(e){return e.boardSize==="24"?"game-screen--board-24":e.boardSize==="36"?"game-screen--board-36":"game-screen--board-16"}const a2="#game-exit-button";function n2(e){e.innerHTML=Q(l()),r2(e)}function r2(e){const t=e.querySelector(a2);t&&t.addEventListener("click",()=>{window.location.hash="#settings"})}const o2="/projects/memory/assets/stadia_controller-CcsXEKot.svg",_="/projects/memory/assets/play-button-CNXT5xaq.svg";function i2(){return`
    ...
    <main class="settings-screen" aria-labelledby="settings-title">
      <div class="settings-screen__canvas">
        <section class="settings-panel">
          ...
          ${d("Game themes",g2,w2(e.theme))}
          ${d("Choose player",p2,S2(e.player))}
          ${d("Board size",f2,E2(e.boardSize))}
        </section>
  ...
  `}function w2(e){return O.map(t=>p("theme",t.value,t.label,e===t.value)).join("")}function S2(e){return T.map(t=>p("player",t.value,t.label,e===t.value)).join("")}function E2(e){return $.map(t=>p("boardSize",t.value,t.label,e===t.value)).join("")}function p(e,t,s,n){const a=n?" is-selected":"",r=n?" is-visible":"",o=n?w:b,c=e==="theme"?` data-preview-theme="${t}"`:"";return`
  ...
  `}function L2(e,t){return`
    <div class="settings-footer__summary" aria-live="polite">
      <div class="settings-footer__fields">
        ${C("theme",B2(e.theme),e.theme!==null,!0)}
        ${C("player",O2(e.player),e.player!==null,!0)}
        ${C("boardSize",T2(e.boardSize),e.boardSize!==null,!1)}
      </div>
      ${$2(t)}
    </div>
  ...
  `}function B2(e){return e?"Game theme":"Theme"}function O2(e){return e?e==="orange"?"Orange Player":"Blue Player":"Player"}function T2(e){return e?`Board-${e} Cards`:"Board size"}function $2(e){return`
    <button
  ...
  `}const I=".settings-option",x2='.settings-option[data-group="theme"]',k2=".settings-option__line",M2=".settings-option__marker",I2=".settings-footer__separator",A2=".settings-preview__image",A="#start-game-button",h="is-refreshing";function P2(e){e.innerHTML=b2(l()),H2(e),F2(e),W2(e),m(e,l().theme)}function H2(e){e.querySelectorAll(I).forEach(s=>{s.addEventListener("click",()=>{R2(e,s.dataset.group,s.dataset.value)})})}function R2(e,t,s){!t||!s||(Z2(t,s),z2(e,l()))}function Z2(e,t){if(e==="theme"&&x(t)){P(t);return}if(e==="player"&&Z(t)){H(t);return}e==="boardSize"&&z(t)&&R(t)}function z2(e,t){N2(e,t),U2(e,t),K2(e),m(e,t.theme)}function F2(e){e.querySelectorAll(x2).forEach(s=>{s.addEventListener("mouseenter",()=>{L(e,s.dataset.previewTheme)}),s.addEventListener("mouseleave",()=>{m(e,l().theme)}),s.addEventListener("focus",()=>{L(e,s.dataset.previewTheme)}),s.addEventListener("blur",()=>{m(e,l().theme)})})}function L(e,t){!t||!x(t)||m(e,t)}function m(e,t){const s=e.querySelector(A2);if(!s)return;const n=t==="foods"?s.dataset.previewFoods:s.dataset.previewCodeVibes||s.dataset.previewDefault;n&&(s.src=n)}function N2(e,t){e.querySelectorAll(I).forEach(n=>{const a=D2(t,n.dataset.group,n.dataset.value);n.classList.toggle("is-selected",a),n.querySelector(k2)?.classList.toggle("is-visible",a);const o=n.querySelector(M2);if(!o)return;const c=a?o.dataset.activeIcon:o.dataset.inactiveIcon;c&&(o.src=c)})}function D2(e,t,s){return!t||!s?!1:t==="theme"?e.theme===s:t==="player"?e.player===s:t==="boardSize"?e.boardSize===s:!1}function U2(e,t){f(e,"theme",t.theme!==null,q2(t.theme)),f(e,"player",t.player!==null,j2(t.player)),f(e,"boardSize",t.boardSize!==null,G2(t.boardSize))}function f(e,t,s,n){const a=e.querySelector(`[data-summary-group="${t}"]`);if(!a)return;const r=a.classList.contains("is-selected");a.classList.toggle("is-selected",s);const o=a.querySelector(I2);if(o){const y=s?o.dataset.separatorActive:o.dataset.separatorInactive;y&&(o.src=y)}const c=a.querySelector(`[data-summary-text="${t}"]`);let v=!1;c&&c.textContent!==n&&(c.textContent=n,v=!0),(s&&!r||v)&&V2(a)}function V2(e){e.classList.remove(h),window.requestAnimationFrame(()=>{e.classList.add(h),window.setTimeout(()=>{e.classList.remove(h)},240)})}function q2(e){return e?"Game theme":"Theme"}function j2(e){return e?e==="orange"?"Orange Player":"Blue Player":"Player"}function G2(e){return e?`Board-${e} Cards`:"Board size"}function K2(e){const t=e.querySelector(A);if(!t)return;const s=g();t.classList.toggle("is-ready",s),t.disabled=!s}function W2(e){const t=e.querySelector(A);t&&t.addEventListener("click",()=>{g()&&(window.location.hash="#game")})}function X2(e){B(e),window.addEventListener("hashchange",()=>{B(e)})}function B(e){const t=J2();if(t==="home"){d2(e);return}if(t==="settings"){P2(e);return}Y2(e)}function Y2(e){if(!g()){window.location.hash="#settings";return}n2(e)}function J2(){const e=window.location.hash.toLowerCase();return e==="#settings"?"settings":e==="#game"?"game":"home"}function Q2(){const e=document.getElementById("app");e&&X2(e)}Q2();
