(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))t(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const o of n.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&t(o)}).observe(document,{childList:!0,subtree:!0});function s(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function t(r){if(r.ep)return;r.ep=!0;const n=s(r);fetch(r.href,n)}})();const j=[{value:"code-vibes",label:"Code vibes theme"},{value:"foods",label:"Foods theme"}],F=[{value:"blue",label:"Blue"},{value:"orange",label:"Orange"}],P=[{value:"16",label:"16 cards"},{value:"24",label:"24 cards"},{value:"36",label:"36 cards"}];let i={boardSize:null,player:null,theme:null};function d(){return{...i}}function U(e){i={...i,theme:e}}function Y(e){i={...i,player:e}}function X(e){i={...i,boardSize:e}}function _(){return!!(i.theme&&i.player&&i.boardSize)}function H(e){return j.some(a=>a.value===e)}function K(e){return F.some(a=>a.value===e)}function W(e){return P.some(a=>a.value===e)}let m=null;function J(e){m={...e}}function Q(){return m?{...m}:null}function ee(){return m!==null}function D(){m=null}const ae="code-vibes",se={"code-vibes":{cssModifierClass:"game-screen--code-vibes"},foods:{cssModifierClass:"game-screen--foods"}};function E(e){return e??ae}function te(e){return se[E(e)].cssModifierClass}const N=`<svg width="10" height="8" viewBox="0 0 10 8" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,re="/projects/memory/assets/exitgame1-BZslv4aI.svg",G="/projects/memory/assets/back-to-game-button-Dy28tT7r.svg",ne="/projects/memory/assets/exit-game-button-CSFmJePI.svg",oe="/projects/memory/assets/exit-game-button-DxiUlG8b.svg",ce="/projects/memory/assets/exit-game-button-hover-CWKYXIiz.svg",ie="/projects/memory/assets/back-to-game-button-BckwOnvC.svg",le="/projects/memory/assets/back-to-game-button-hover-CltZJA0Z.svg",de="/projects/memory/assets/exit-game-button-overlay-BmTcSkCT.svg",me="/projects/memory/assets/exit-game-button-overlay-hover-CHeUaH3n.svg",ue="/projects/memory/assets/Cards%205-DZnpmrpx.svg",ge="/projects/memory/assets/angular-card-CMiTHiGh.svg",pe="/projects/memory/assets/bootstrap-card-Rq83vZTa.svg",Ce="/projects/memory/assets/css-card-Yna33ZIc.svg",_e="/projects/memory/assets/database-card-DZJGMO6r.svg",fe="/projects/memory/assets/django-card-zdDnWkPj.svg",ve="/projects/memory/assets/firebase-card-BGJGDkPQ.svg",he="/projects/memory/assets/guthub-card-C0OAhCwn.svg",be="/projects/memory/assets/html5-card-CuL2MCMe.svg",ye="/projects/memory/assets/js-card-vn5hBh96.svg",Se="/projects/memory/assets/node-card-Dum8zyHj.svg",we="/projects/memory/assets/python-card-xA_4epsW.svg",Ee="/projects/memory/assets/react-card-CIELOEMr.svg",Le="/projects/memory/assets/sass-card-DwnRYj6b.svg",xe="/projects/memory/assets/terminal-card-B7_Z2NcV.svg",ke="/projects/memory/assets/ts-card-BKPozS6g.svg",Ie="/projects/memory/assets/vscode-card-fF042ORC.svg",Oe="/projects/memory/assets/vue-card-BoB3VO2b.svg",Be="/projects/memory/assets/back-card-D-qRVjX3.svg",Te="/projects/memory/assets/brezel-card-CXqqkZs-.svg",$e="/projects/memory/assets/cake-card-BXMN5G8t.svg",Me="/projects/memory/assets/chicken-card-V3orblRE.svg",Ae="/projects/memory/assets/chocolate-card-QAzOvrHx.svg",Re="/projects/memory/assets/corndog-card-CwpjZjE3.svg",je="/projects/memory/assets/donut-card-C0Ssqpoo.svg",Fe="/projects/memory/assets/hamburger-card-CjV68Ggw.svg",Pe="/projects/memory/assets/icecream-card-CoO_ylkx.svg",He="/projects/memory/assets/macron-card-D9lMrSKW.svg",De="/projects/memory/assets/muffin-card-DO8Rb5nk.svg",Ne="/projects/memory/assets/pizza-card-CCl09bmZ.svg",Ze="/projects/memory/assets/pommes-card-KiUYGabn.svg",Ge="/projects/memory/assets/pudding-card-Ct1M7kVT.svg",ze="/projects/memory/assets/salad-card-8HQ_A0VA.svg",Ve="/projects/memory/assets/sandwich-card-Z1FA70DW.svg",qe="/projects/memory/assets/sushi-card-DUXi4ArE.svg",Ue="/projects/memory/assets/tacco-card-D5AQdy9w.svg",Ye="/projects/memory/assets/wrao-card-CLUKRYIs.svg",Xe=[ge,pe,Ce,_e,fe,ve,he,be,ye,Se,we,Ee,Le,xe,ke,Ie,Oe],Ke=[Te,$e,Me,Ae,Re,je,Fe,Pe,He,De,Ne,Ze,Ge,ze,Ve,qe,Ue,Ye],z={"code-vibes":{backCardSprite:ue,faceIcons:Xe},foods:{backCardSprite:Be,faceIcons:Ke}};function We(e){const a=E(e.theme),s=te(e.theme),t=e.boardSize??"16",r=i2(t),n=n2(t,a),o=e.player==="orange"?" is-orange":" is-blue",c=a==="foods"?e2(o):Je(o);return`
    <main class="game-screen ${s} ${r}" aria-labelledby="game-title">
  ...
  `}function a2(){return Z.replace(/fill="#097FC5"/gi,'fill="currentColor"').trim()}function s2(e){return e==="foods"?r2():t2()}function t2(){return`
    <div
  ...
  `}function n2(e,a){const s=Number.parseInt(e,10),t=Number.isFinite(s)&&s>0?s:16,r=z[a],n=Math.floor(t/2),o=o2(n,a);return c2([...o,...o]).map((l,g)=>`
      <button
        class="game-card"
        type="button"
        data-card-index="${g}"
    ...
    `).join("")}function o2(e,a){const s=z[a].faceIcons;return Array.from({length:e},(t,r)=>s[r%s.length])}function c2(e){const a=[...e];for(let s=a.length-1;s>0;s-=1){const t=Math.floor(Math.random()*(s+1));[a[s],a[t]]=[a[t],a[s]]}return a}function i2(e){return e==="24"?"game-screen--board-24":e==="36"?"game-screen--board-36":"game-screen--board-16"}const l2="#game-exit-button",d2="[data-exit-modal]",m2="[data-exit-cancel]",u2="[data-exit-confirm]",g2=".game-screen",k="is-exit-modal-open",p2=".game-card",C2="[data-current-player-marker]",p="flipped",C="is-matched",_2=700,f2=320;function v2(e){const a=d();e.innerHTML=We(a),h2(e),b2(e,a.player??"blue")}function h2(e){const a=e.querySelector(l2),s=e.querySelector(d2),t=e.querySelector(m2),r=e.querySelector(u2),n=e.querySelector(g2);if(!a||!s||!t||!r||!n)return;const o=()=>{s.hidden=!1,n.classList.add(k)},c=()=>{s.hidden=!0,n.classList.remove(k)};a.addEventListener("click",()=>{o()}),t.addEventListener("click",()=>{c()}),r.addEventListener("click",()=>{window.location.hash="#settings"})}function b2(e,a){const s=Array.from(e.querySelectorAll(p2));if(s.length===0)return;const t={currentPlayer:a,firstFlippedCard:null,secondFlippedCard:null,isTurnLocked:!1,scores:{blue:0,orange:0}};L(e,t),s.forEach(r=>{r.addEventListener("click",()=>{y2(e,s.length,t,r)})})}function y2(e,a,s,t){if(s.isTurnLocked||t.classList.contains(p)||t.classList.contains(C))return;if(f(t),!s.firstFlippedCard){s.firstFlippedCard=t;return}if(s.secondFlippedCard=t,s.isTurnLocked=!0,S2(s.firstFlippedCard,s.secondFlippedCard)){w2(e,a,s);return}window.setTimeout(()=>{s.firstFlippedCard&&s.firstFlippedCard.classList.contains(p)&&f(s.firstFlippedCard),s.secondFlippedCard&&s.secondFlippedCard.classList.contains(p)&&f(s.secondFlippedCard),s.currentPlayer=s.currentPlayer==="blue"?"orange":"blue",w(s),L(e,s)},_2)}function f(e){e.classList.toggle(p)}function S2(e,a){const s=e.dataset.cardIcon,t=a.dataset.cardIcon;return!!(s&&t&&s===t)}function w2(e,a,s){const t=s.firstFlippedCard,r=s.secondFlippedCard;if(!t||!r){w(s);return}t.classList.add(C),r.classList.add(C),t.disabled=!0,r.disabled=!0,s.scores[s.currentPlayer]+=1,w(s),L(e,s),e.querySelectorAll(`.${C}`).length===a&&window.setTimeout(()=>{J({blueScore:s.scores.blue,orangeScore:s.scores.orange}),window.location.hash="#game-over"},f2)}function w(e){e.firstFlippedCard=null,e.secondFlippedCard=null,e.isTurnLocked=!1}function L(e,a){I(e,"blue",a.scores.blue),I(e,"orange",a.scores.orange);const s=e.querySelector(C2);s&&s.classList.toggle("is-orange",a.currentPlayer==="orange")}function I(e,a,s){const t=e.querySelectorAll(`[data-score-player="${a}"]`);t.length!==0&&t.forEach(r=>{r.textContent=String(s)})}const E2="/projects/memory/assets/Confetti-Ze9Uy3By.svg";function L2(e,a){const s=E(a),t=s==="foods",r=t?"game-over-screen--foods":"game-over-screen--code-vibes",n=t?k2():x2(),o=O2(e),c=I2(e,n,s),l=t?"":`
        <img
    ...
    >
      ...
      <section class="game-over-screen__winner-page" aria-live="polite">
        ...
        <div class="game-over-screen__winner-content">
          ${o.isDraw?"":'<p class="game-over-screen__winner-prefix">the winner is</p>'}
          <p class="game-over-screen__winner-player ${o.className}">
            ${o.label}
          </p>
  ...
  `}function x2(){return N.replace(/fill="#2BB1FF"/gi,'fill="currentColor"').trim()}function k2(){return Z.replace(/fill="#097FC5"/gi,'fill="currentColor"').trim()}function I2(e,a,s){return s==="foods"?`
  ...
  `}function O2(e){return e.blueScore>e.orangeScore?{isDraw:!1,className:"game-over-screen__winner-player--blue",label:"BLUE PLAYER"}:e.orangeScore>e.blueScore?{isDraw:!1,className:"game-over-screen__winner-player--orange",label:"ORANGE PLAYER"}:{isDraw:!0,className:"game-over-screen__winner-player--draw",label:"DRAW"}}const B2=2200,T2="[data-game-over-screen]",$2="[data-back-home-button]",M2="is-winner-visible";function A2(e){const a=Q(),s=d();if(!a){window.location.hash="#game";return}e.innerHTML=L2(a,s.theme),e.querySelector($2)?.addEventListener("click",()=>{D(),window.location.hash="#home"});const r=e.querySelector(T2);r&&window.setTimeout(()=>{!e.isConnected||window.location.hash!=="#game-over"||r.classList.add(M2)},B2)}const R2="/projects/memory/assets/stadia_controller-CcsXEKot.svg",O="/projects/memory/assets/play-button-CNXT5xaq.svg";function j2(){return`
    ...
    <main class="settings-screen" aria-labelledby="settings-title">
      <div class="settings-screen__canvas">
        <section class="settings-panel">
          ...
          ${h("Game themes",V2,W2(e.theme))}
          ${h("Choose player",q2,J2(e.player))}
          ${h("Board size",z2,Q2(e.boardSize))}
        </section>
        ...
        <aside class="settings-preview">
          <img
            ...
            src="${s}"
            data-preview-default="${v}"
            data-preview-code-vibes="${v}"
  ...
  `}function W2(e){return j.map(a=>x("theme",a.value,a.label,e===a.value)).join("")}function J2(e){return F.map(a=>x("player",a.value,a.label,e===a.value)).join("")}function Q2(e){return P.map(a=>x("boardSize",a.value,a.label,e===a.value)).join("")}function x(e,a,s,t){const r=t?" is-selected":"",n=t?" is-visible":"",o=t?T:B,c=e==="theme"?` data-preview-theme="${a}"`:"";return`
  ...
  `}function a0(e){return e?"Game theme":"Theme"}function s0(e){return e?e==="orange"?"Orange Player":"Blue Player":"Player"}function t0(e){return e?`Board-${e} Cards`:"Board size"}function r0(e){return`
    <button
  ...
  `}const V=".settings-option",n0='.settings-option[data-group="theme"]',o0=".settings-option__line",c0=".settings-option__marker",i0=".settings-footer__separator",l0=".settings-preview__image",q="#start-game-button",y="is-refreshing";function d0(e){e.innerHTML=K2(d()),m0(e),C0(e),E0(e),u(e,d().theme)}function m0(e){e.querySelectorAll(V).forEach(s=>{s.addEventListener("click",()=>{u0(e,s.dataset.group,s.dataset.value)})})}function u0(e,a,s){!a||!s||(g0(a,s),p0(e,d()))}function g0(e,a){if(e==="theme"&&H(a)){U(a);return}if(e==="player"&&K(a)){Y(a);return}e==="boardSize"&&W(a)&&X(a)}function p0(e,a){_0(e,a),v0(e,a),w0(e),u(e,a.theme)}function C0(e){e.querySelectorAll(n0).forEach(s=>{s.addEventListener("mouseenter",()=>{A(e,s.dataset.previewTheme)}),s.addEventListener("mouseleave",()=>{u(e,d().theme)}),s.addEventListener("focus",()=>{A(e,s.dataset.previewTheme)}),s.addEventListener("blur",()=>{u(e,d().theme)})})}function A(e,a){!a||!H(a)||u(e,a)}function u(e,a){const s=e.querySelector(l0);if(!s)return;const t=a==="foods"?s.dataset.previewFoods:s.dataset.previewCodeVibes||s.dataset.previewDefault;t&&(s.src=t)}function _0(e,a){e.querySelectorAll(V).forEach(t=>{const r=f0(a,t.dataset.group,t.dataset.value);t.classList.toggle("is-selected",r),t.querySelector(o0)?.classList.toggle("is-visible",r);const o=t.querySelector(c0);if(!o)return;const c=r?o.dataset.activeIcon:o.dataset.inactiveIcon;c&&(o.src=c)})}function f0(e,a,s){return!a||!s?!1:a==="theme"?e.theme===s:a==="player"?e.player===s:a==="boardSize"?e.boardSize===s:!1}function v0(e,a){S(e,"theme",a.theme!==null,b0(a.theme)),S(e,"player",a.player!==null,y0(a.player)),S(e,"boardSize",a.boardSize!==null,S0(a.boardSize))}function S(e,a,s,t){const r=e.querySelector(`[data-summary-group="${a}"]`);if(!r)return;const n=r.classList.contains("is-selected");r.classList.toggle("is-selected",s);const o=r.querySelector(i0);if(o){const g=s?o.dataset.separatorActive:o.dataset.separatorInactive;g&&(o.src=g)}const c=r.querySelector(`[data-summary-text="${a}"]`);let l=!1;c&&c.textContent!==t&&(c.textContent=t,l=!0),(s&&!n||l)&&h0(r)}function h0(e){e.classList.remove(y),window.requestAnimationFrame(()=>{e.classList.add(y),window.setTimeout(()=>{e.classList.remove(y)},240)})}function b0(e){return e?"Game theme":"Theme"}function y0(e){return e?e==="orange"?"Orange Player":"Blue Player":"Player"}function S0(e){return e?`Board-${e} Cards`:"Board size"}function w0(e){const a=e.querySelector(q);if(!a)return;const s=_();a.classList.toggle("is-ready",s),a.disabled=!s}function E0(e){const a=e.querySelector(q);a&&a.addEventListener("click",()=>{_()&&(D(),window.location.hash="#game")})}function L0(e){R(e),window.addEventListener("hashchange",()=>{R(e)})}function R(e){const a=I0();if(a==="home"){N2(e);return}if(a==="settings"){d0(e);return}if(a==="game-over"){k0(e);return}x0(e)}function x0(e){if(!_()){window.location.hash="#settings";return}v2(e)}function k0(e){if(!_()){window.location.hash="#settings";return}if(!ee()){window.location.hash="#game";return}A2(e)}function I0(){const e=window.location.hash.toLowerCase();return e==="#settings"?"settings":e==="#game"?"game":e==="#game-over"?"game-over":"home"}function O0(){const e=document.getElementById("app");e&&L0(e)}O0();
