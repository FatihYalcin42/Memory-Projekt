(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))n(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function s(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerPolicy&&(r.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?r.credentials="include":a.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(a){if(a.ep)return;a.ep=!0;const r=s(a);fetch(a.href,r)}})();const O=[{value:"code-vibes",label:"Code vibes theme"},{value:"foods",label:"Foods theme"}],$=[{value:"blue",label:"Blue"},{value:"orange",label:"Orange"}],T=[{value:"16",label:"16 cards"},{value:"24",label:"24 cards"},{value:"36",label:"36 cards"}];let i={boardSize:null,player:null,theme:null};function l(){return{...i}}function I(e){i={...i,theme:e}}function P(e){i={...i,player:e}}function A(e){i={...i,boardSize:e}}function f(){return!!(i.theme&&i.player&&i.boardSize)}function x(e){return O.some(t=>t.value===e)}function H(e){return $.some(t=>t.value===e)}function R(e){return T.some(t=>t.value===e)}const Z="/projects/memory/assets/Code%20vibes%20theme_16-DnDZKwbK.svg",F="/projects/memory/assets/Code%20vibes%20theme_24-B6WV80WL.svg",z="/projects/memory/assets/Code%20vibes%20theme_36-DBGuI9rU.svg",N="/projects/memory/assets/Food_theme_16-C22FWGub.svg",j="/projects/memory/assets/Food_theme_24-CMaMg8km.svg",q="/projects/memory/assets/Food_theme_36-DpVdfDWc.svg",D="code-vibes",G={"code-vibes":{boardImages:{16:Z,24:F,36:z},cssModifierClass:"game-screen--code-vibes"},foods:{boardImages:{16:N,24:j,36:q},cssModifierClass:"game-screen--foods"}};function U(e){return e??D}function V(e){return G[U(e)].cssModifierClass}const K=`<svg width="10" height="8" viewBox="0 0 10 8" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,W="/projects/memory/assets/exitgame1-BZslv4aI.svg";function X(e){const t=V(e.theme),s=e.boardSize??"16",n=t2(s),a=e2(s),r=e.theme!=="foods",o=e.player==="orange"?" is-orange":" is-blue";return`
    <main class="game-screen ${t} ${n}" aria-labelledby="game-title">
  ...
  `}function J(){return K.replace(/fill="#2BB1FF"/gi,'fill="currentColor"').trim()}function Q(){return`
    <div class="game-screen__hud">
      <button
        id="game-exit-button"
  ...
  `}function e2(e){const t=Number.parseInt(e,10);return Array.from({length:t},(s,n)=>`
      <button class="game-card" type="button" data-card-index="${n}">
    ...
    `).join("")}function t2(e){return e==="24"?"game-screen--board-24":e==="36"?"game-screen--board-36":"game-screen--board-16"}const s2="#game-exit-button";function a2(e){e.innerHTML=X(l()),n2(e)}function n2(e){const t=e.querySelector(s2);t&&t.addEventListener("click",()=>{window.location.hash="#settings"})}const r2="/projects/memory/assets/stadia_controller-CcsXEKot.svg",y="/projects/memory/assets/play-button-CNXT5xaq.svg";function o2(){return`
    ...
    <main class="settings-screen" aria-labelledby="settings-title">
      <div class="settings-screen__canvas">
        <section class="settings-panel">
          ...
          ${u("Game themes",g2,b2(e.theme))}
          ${u("Choose player",f2,w2(e.player))}
          ${u("Board size",p2,S2(e.boardSize))}
        </section>
  ...
  `}function b2(e){return O.map(t=>h("theme",t.value,t.label,e===t.value)).join("")}function w2(e){return $.map(t=>h("player",t.value,t.label,e===t.value)).join("")}function S2(e){return T.map(t=>h("boardSize",t.value,t.label,e===t.value)).join("")}function h(e,t,s,n){const a=n?" is-selected":"",r=n?" is-visible":"",o=n?w:b,c=e==="theme"?` data-preview-theme="${t}"`:"";return`
  ...
  `}function E2(e,t){return`
    <div class="settings-footer__summary" aria-live="polite">
      <div class="settings-footer__fields">
        ${C("theme",L2(e.theme),e.theme!==null,!0)}
        ${C("player",B2(e.player),e.player!==null,!0)}
        ${C("boardSize",O2(e.boardSize),e.boardSize!==null,!1)}
      </div>
      ${$2(t)}
    </div>
  `}function C(e,t,s,n){const a=s?" is-selected":"",r=n?`<img
      class="settings-footer__separator"
      src="${S}"
      data-separator-inactive="${S}"
      data-separator-active="${h2}"
      alt=""
      aria-hidden="true"
    />`:"";return`
  ...
  `}function L2(e){return e?"Game theme":"Theme"}function B2(e){return e?e==="orange"?"Orange Player":"Blue Player":"Player"}function O2(e){return e?`Board-${e} Cards`:"Board size"}function $2(e){return`
    <button
  ...
  `}const k=".settings-option",T2='.settings-option[data-group="theme"]',x2=".settings-option__line",k2=".settings-option__marker",M2=".settings-footer__separator",I2=".settings-preview__image",M="#start-game-button",p="is-refreshing";function P2(e){e.innerHTML=y2(l()),A2(e),F2(e),K2(e),m(e,l().theme)}function A2(e){e.querySelectorAll(k).forEach(s=>{s.addEventListener("click",()=>{H2(e,s.dataset.group,s.dataset.value)})})}function H2(e,t,s){!t||!s||(R2(t,s),Z2(e,l()))}function R2(e,t){if(e==="theme"&&x(t)){I(t);return}if(e==="player"&&H(t)){P(t);return}e==="boardSize"&&R(t)&&A(t)}function Z2(e,t){z2(e,t),j2(e,t),V2(e),m(e,t.theme)}function F2(e){e.querySelectorAll(T2).forEach(s=>{s.addEventListener("mouseenter",()=>{L(e,s.dataset.previewTheme)}),s.addEventListener("mouseleave",()=>{m(e,l().theme)}),s.addEventListener("focus",()=>{L(e,s.dataset.previewTheme)}),s.addEventListener("blur",()=>{m(e,l().theme)})})}function L(e,t){!t||!x(t)||m(e,t)}function m(e,t){const s=e.querySelector(I2);if(!s)return;const n=t==="foods"?s.dataset.previewFoods:s.dataset.previewCodeVibes||s.dataset.previewDefault;n&&(s.src=n)}function z2(e,t){e.querySelectorAll(k).forEach(n=>{const a=N2(t,n.dataset.group,n.dataset.value);n.classList.toggle("is-selected",a),n.querySelector(x2)?.classList.toggle("is-visible",a);const o=n.querySelector(k2);if(!o)return;const c=a?o.dataset.activeIcon:o.dataset.inactiveIcon;c&&(o.src=c)})}function N2(e,t,s){return!t||!s?!1:t==="theme"?e.theme===s:t==="player"?e.player===s:t==="boardSize"?e.boardSize===s:!1}function j2(e,t){g(e,"theme",t.theme!==null,D2(t.theme)),g(e,"player",t.player!==null,G2(t.player)),g(e,"boardSize",t.boardSize!==null,U2(t.boardSize))}function g(e,t,s,n){const a=e.querySelector(`[data-summary-group="${t}"]`);if(!a)return;const r=a.classList.contains("is-selected");a.classList.toggle("is-selected",s);const o=a.querySelector(M2);if(o){const v=s?o.dataset.separatorActive:o.dataset.separatorInactive;v&&(o.src=v)}const c=a.querySelector(`[data-summary-text="${t}"]`);let _=!1;c&&c.textContent!==n&&(c.textContent=n,_=!0),(s&&!r||_)&&q2(a)}function q2(e){e.classList.remove(p),window.requestAnimationFrame(()=>{e.classList.add(p),window.setTimeout(()=>{e.classList.remove(p)},240)})}function D2(e){return e?"Game theme":"Theme"}function G2(e){return e?e==="orange"?"Orange Player":"Blue Player":"Player"}function U2(e){return e?`Board-${e} Cards`:"Board size"}function V2(e){const t=e.querySelector(M);if(!t)return;const s=f();t.classList.toggle("is-ready",s),t.disabled=!s}function K2(e){const t=e.querySelector(M);t&&t.addEventListener("click",()=>{f()&&(window.location.hash="#game")})}function W2(e){B(e),window.addEventListener("hashchange",()=>{B(e)})}function B(e){const t=Y2();if(t==="home"){d2(e);return}if(t==="settings"){P2(e);return}X2(e)}function X2(e){if(!f()){window.location.hash="#settings";return}a2(e)}function Y2(){const e=window.location.hash.toLowerCase();return e==="#settings"?"settings":e==="#game"?"game":"home"}function J2(){const e=document.getElementById("app");e&&W2(e)}J2();
