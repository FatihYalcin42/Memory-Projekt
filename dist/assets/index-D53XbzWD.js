(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))a(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const o of n.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&a(o)}).observe(document,{childList:!0,subtree:!0});function s(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function a(r){if(r.ep)return;r.ep=!0;const n=s(r);fetch(r.href,n)}})();const A=[{value:"code-vibes",label:"Code vibes theme"},{value:"foods",label:"Foods theme"}],P=[{value:"blue",label:"Blue"},{value:"orange",label:"Orange"}],F=[{value:"16",label:"16 cards"},{value:"24",label:"24 cards"},{value:"36",label:"36 cards"}];let c={boardSize:null,player:null,theme:null};function l(){return{...c}}function Z(e){c={...c,theme:e}}function D(e){c={...c,player:e}}function z(e){c={...c,boardSize:e}}function _(){return!!(c.theme&&c.player&&c.boardSize)}function R(e){return A.some(t=>t.value===e)}function N(e){return P.some(t=>t.value===e)}function q(e){return F.some(t=>t.value===e)}const G="/projects/memory/assets/Code%20vibes%20theme_16-DnDZKwbK.svg",V="/projects/memory/assets/Code%20vibes%20theme_24-B6WV80WL.svg",U="/projects/memory/assets/Code%20vibes%20theme_36-DBGuI9rU.svg",K="/projects/memory/assets/Food_theme_16-C22FWGub.svg",W="/projects/memory/assets/Food_theme_24-CMaMg8km.svg",Y="/projects/memory/assets/Food_theme_36-DpVdfDWc.svg",X="code-vibes",J={"code-vibes":{boardImages:{16:G,24:V,36:U},cssModifierClass:"game-screen--code-vibes"},foods:{boardImages:{16:K,24:W,36:Y},cssModifierClass:"game-screen--foods"}};function Q(e){return e??X}function e2(e){return J[Q(e)].cssModifierClass}const t2=`<svg width="10" height="8" viewBox="0 0 10 8" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,s2="/projects/memory/assets/exitgame1-BZslv4aI.svg",a2="/projects/memory/assets/Cards%205-DZnpmrpx.svg",r2="/projects/memory/assets/angular-card-CMiTHiGh.svg",n2="/projects/memory/assets/bootstrap-card-Rq83vZTa.svg",o2="/projects/memory/assets/css-card-Yna33ZIc.svg",i2="/projects/memory/assets/database-card-DZJGMO6r.svg",c2="/projects/memory/assets/django-card-zdDnWkPj.svg",l2="/projects/memory/assets/firebase-card-BGJGDkPQ.svg",d2="/projects/memory/assets/guthub-card-C0OAhCwn.svg",u2="/projects/memory/assets/html5-card-CuL2MCMe.svg",m2="/projects/memory/assets/js-card-vn5hBh96.svg",C2="/projects/memory/assets/node-card-Dum8zyHj.svg",p2="/projects/memory/assets/python-card-xA_4epsW.svg",g2="/projects/memory/assets/react-card-CIELOEMr.svg",f2="/projects/memory/assets/sass-card-DwnRYj6b.svg",h2="/projects/memory/assets/terminal-card-B7_Z2NcV.svg",v2="/projects/memory/assets/ts-card-BKPozS6g.svg",y2="/projects/memory/assets/vscode-card-fF042ORC.svg",_2="/projects/memory/assets/vue-card-BoB3VO2b.svg",E=[r2,n2,o2,i2,c2,l2,d2,u2,m2,C2,p2,g2,f2,h2,v2,y2,_2];function b2(e){const t=e2(e.theme),s=e.boardSize??"16",a=O2(s),r=E2(s),n=e.theme!=="foods",o=e.player==="orange"?" is-orange":" is-blue";return`
  ...
  `}function w2(e){const t=S2();return`
  ...
  `}function S2(){return t2.replace(/fill="#2BB1FF"/gi,'fill="currentColor"').trim()}function L2(){return`
    <div class="game-screen__hud">
      <button
        id="game-exit-button"
  ...
  `}function E2(e){const t=Number.parseInt(e,10),s=Number.isFinite(t)&&t>0?t:16,a=Math.floor(s/2),r=B2(a);return I2([...r,...r]).map((o,i)=>`
      <button
        class="game-card"
        type="button"
        data-card-index="${i}"
    ...
    `).join("")}function B2(e){return Array.from({length:e},(t,s)=>E[s%E.length])}function I2(e){const t=[...e];for(let s=t.length-1;s>0;s-=1){const a=Math.floor(Math.random()*(s+1));[t[s],t[a]]=[t[a],t[s]]}return t}function O2(e){return e==="24"?"game-screen--board-24":e==="36"?"game-screen--board-36":"game-screen--board-16"}const T2="#game-exit-button",$2=".game-card",k2="[data-current-player-marker]",u="flipped",m="is-matched",M2=700;function x2(e){const t=l();e.innerHTML=b2(t),A2(e),P2(e,t.player??"blue")}function A2(e){const t=e.querySelector(T2);t&&t.addEventListener("click",()=>{window.location.hash="#settings"})}function P2(e,t){const s=Array.from(e.querySelectorAll($2));if(s.length===0)return;const a={currentPlayer:t,firstFlippedCard:null,secondFlippedCard:null,isTurnLocked:!1,scores:{blue:0,orange:0}};b(e,a),s.forEach(r=>{r.addEventListener("click",()=>{F2(e,s.length,a,r)})})}function F2(e,t,s,a){if(s.isTurnLocked||a.classList.contains(u)||a.classList.contains(m))return;if(C(a),!s.firstFlippedCard){s.firstFlippedCard=a;return}if(s.secondFlippedCard=a,s.isTurnLocked=!0,R2(s.firstFlippedCard,s.secondFlippedCard)){j2(e,t,s);return}window.setTimeout(()=>{s.firstFlippedCard&&s.firstFlippedCard.classList.contains(u)&&C(s.firstFlippedCard),s.secondFlippedCard&&s.secondFlippedCard.classList.contains(u)&&C(s.secondFlippedCard),s.currentPlayer=s.currentPlayer==="blue"?"orange":"blue",y(s),b(e,s)},M2)}function C(e){e.classList.toggle(u)}function R2(e,t){const s=e.dataset.cardIcon,a=t.dataset.cardIcon;return!!(s&&a&&s===a)}function j2(e,t,s){const a=s.firstFlippedCard,r=s.secondFlippedCard;if(!a||!r){y(s);return}a.classList.add(m),r.classList.add(m),a.disabled=!0,r.disabled=!0,s.scores[s.currentPlayer]+=1,y(s),b(e,s),e.querySelectorAll(`.${m}`).length===t&&e.classList.add("game-screen--finished")}function y(e){e.firstFlippedCard=null,e.secondFlippedCard=null,e.isTurnLocked=!1}function b(e,t){B(e,"blue",t.scores.blue),B(e,"orange",t.scores.orange);const s=e.querySelector(k2);s&&s.classList.toggle("is-orange",t.currentPlayer==="orange")}function B(e,t,s){const a=e.querySelector(`[data-score-player="${t}"]`);a&&(a.textContent=String(s))}const H2="/projects/memory/assets/stadia_controller-CcsXEKot.svg",I="/projects/memory/assets/play-button-CNXT5xaq.svg";function Z2(){return`
    ...
    <main class="settings-screen" aria-labelledby="settings-title">
      <div class="settings-screen__canvas">
        <section class="settings-panel">
          ...
          ${g("Game themes",W2,t0(e.theme))}
          ${g("Choose player",Y2,s0(e.player))}
          ${g("Board size",K2,a0(e.boardSize))}
        </section>
  ...
  `}function t0(e){return A.map(t=>w("theme",t.value,t.label,e===t.value)).join("")}function s0(e){return P.map(t=>w("player",t.value,t.label,e===t.value)).join("")}function a0(e){return F.map(t=>w("boardSize",t.value,t.label,e===t.value)).join("")}function w(e,t,s,a){const r=a?" is-selected":"",n=a?" is-visible":"",o=a?T:O,i=e==="theme"?` data-preview-theme="${t}"`:"";return`
  ...
  `}function r0(e,t){return`
    <div class="settings-footer__summary" aria-live="polite">
      <div class="settings-footer__fields">
        ${f("theme",n0(e.theme),e.theme!==null,!0)}
        ${f("player",o0(e.player),e.player!==null,!0)}
        ${f("boardSize",i0(e.boardSize),e.boardSize!==null,!1)}
      </div>
      ${c0(t)}
    </div>
  `}function f(e,t,s,a){const r=s?" is-selected":"",n=a?`<img
      class="settings-footer__separator"
      src="${$}"
      data-separator-inactive="${$}"
      data-separator-active="${X2}"
      alt=""
      aria-hidden="true"
    />`:"";return`
  ...
  `}function n0(e){return e?"Game theme":"Theme"}function o0(e){return e?e==="orange"?"Orange Player":"Blue Player":"Player"}function i0(e){return e?`Board-${e} Cards`:"Board size"}function c0(e){return`
    <button
  ...
  `}const j=".settings-option",l0='.settings-option[data-group="theme"]',d0=".settings-option__line",u0=".settings-option__marker",m0=".settings-footer__separator",C0=".settings-preview__image",H="#start-game-button",h="is-refreshing";function p0(e){e.innerHTML=e0(l()),g0(e),y0(e),O0(e),d(e,l().theme)}function g0(e){e.querySelectorAll(j).forEach(s=>{s.addEventListener("click",()=>{f0(e,s.dataset.group,s.dataset.value)})})}function f0(e,t,s){!t||!s||(h0(t,s),v0(e,l()))}function h0(e,t){if(e==="theme"&&R(t)){Z(t);return}if(e==="player"&&N(t)){D(t);return}e==="boardSize"&&q(t)&&z(t)}function v0(e,t){_0(e,t),w0(e,t),I0(e),d(e,t.theme)}function y0(e){e.querySelectorAll(l0).forEach(s=>{s.addEventListener("mouseenter",()=>{M(e,s.dataset.previewTheme)}),s.addEventListener("mouseleave",()=>{d(e,l().theme)}),s.addEventListener("focus",()=>{M(e,s.dataset.previewTheme)}),s.addEventListener("blur",()=>{d(e,l().theme)})})}function M(e,t){!t||!R(t)||d(e,t)}function d(e,t){const s=e.querySelector(C0);if(!s)return;const a=t==="foods"?s.dataset.previewFoods:s.dataset.previewCodeVibes||s.dataset.previewDefault;a&&(s.src=a)}function _0(e,t){e.querySelectorAll(j).forEach(a=>{const r=b0(t,a.dataset.group,a.dataset.value);a.classList.toggle("is-selected",r),a.querySelector(d0)?.classList.toggle("is-visible",r);const o=a.querySelector(u0);if(!o)return;const i=r?o.dataset.activeIcon:o.dataset.inactiveIcon;i&&(o.src=i)})}function b0(e,t,s){return!t||!s?!1:t==="theme"?e.theme===s:t==="player"?e.player===s:t==="boardSize"?e.boardSize===s:!1}function w0(e,t){v(e,"theme",t.theme!==null,L0(t.theme)),v(e,"player",t.player!==null,E0(t.player)),v(e,"boardSize",t.boardSize!==null,B0(t.boardSize))}function v(e,t,s,a){const r=e.querySelector(`[data-summary-group="${t}"]`);if(!r)return;const n=r.classList.contains("is-selected");r.classList.toggle("is-selected",s);const o=r.querySelector(m0);if(o){const L=s?o.dataset.separatorActive:o.dataset.separatorInactive;L&&(o.src=L)}const i=r.querySelector(`[data-summary-text="${t}"]`);let S=!1;i&&i.textContent!==a&&(i.textContent=a,S=!0),(s&&!n||S)&&S0(r)}function S0(e){e.classList.remove(h),window.requestAnimationFrame(()=>{e.classList.add(h),window.setTimeout(()=>{e.classList.remove(h)},240)})}function L0(e){return e?"Game theme":"Theme"}function E0(e){return e?e==="orange"?"Orange Player":"Blue Player":"Player"}function B0(e){return e?`Board-${e} Cards`:"Board size"}function I0(e){const t=e.querySelector(H);if(!t)return;const s=_();t.classList.toggle("is-ready",s),t.disabled=!s}function O0(e){const t=e.querySelector(H);t&&t.addEventListener("click",()=>{_()&&(window.location.hash="#game")})}function T0(e){x(e),window.addEventListener("hashchange",()=>{x(e)})}function x(e){const t=k0();if(t==="home"){G2(e);return}if(t==="settings"){p0(e);return}$0(e)}function $0(e){if(!_()){window.location.hash="#settings";return}x2(e)}function k0(){const e=window.location.hash.toLowerCase();return e==="#settings"?"settings":e==="#game"?"game":"home"}function M0(){const e=document.getElementById("app");e&&T0(e)}M0();
