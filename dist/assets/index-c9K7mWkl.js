(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))o(n);new MutationObserver(n=>{for(const a of n)if(a.type==="childList")for(const r of a.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&o(r)}).observe(document,{childList:!0,subtree:!0});function s(n){const a={};return n.integrity&&(a.integrity=n.integrity),n.referrerPolicy&&(a.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?a.credentials="include":n.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function o(n){if(n.ep)return;n.ep=!0;const a=s(n);fetch(n.href,a)}})();const u=[{value:"code-vibes",label:"Code vibes theme"},{value:"foods",label:"Foods theme"}],C=[{value:"blue",label:"Blue"},{value:"orange",label:"Orange"}],d=[{value:"16",label:"16 cards"},{value:"24",label:"24 cards"},{value:"36",label:"36 cards"}];let i={boardSize:null,player:null,theme:null};function f(){return{...i}}function b(e){i={...i,theme:e}}function y(e){i={...i,player:e}}function _(e){i={...i,boardSize:e}}function g(){return!!(i.theme&&i.player&&i.boardSize)}function w(e){return u.some(t=>t.value===e)}function S(e){return C.some(t=>t.value===e)}function L(e){return d.some(t=>t.value===e)}const k="/projects/memory/assets/Code%20vibes%20theme_16-DnDZKwbK.svg",B="/projects/memory/assets/Code%20vibes%20theme_24-B6WV80WL.svg",O="/projects/memory/assets/Code%20vibes%20theme_36-DBGuI9rU.svg",E="/projects/memory/assets/Food_theme_16-C22FWGub.svg",$="/projects/memory/assets/Food_theme_24-CMaMg8km.svg",M="/projects/memory/assets/Food_theme_36-DpVdfDWc.svg",x={"code-vibes":{16:k,24:B,36:O},foods:{16:E,24:$,36:M}};function T(e){return`
    <main class="game-screen" aria-labelledby="game-title">
      <div class="game-screen__canvas">
        <img
          class="game-screen__board"
          src="${Z(e.theme,e.boardSize)}"
          alt="Memory board"
        />

        <header class="game-screen__overlay">
          <h1 id="game-title">Game</h1>
          <p>${I(e.theme,e.player,e.boardSize)}</p>
          <button id="game-back-button" type="button">Settings</button>
        </header>
      </div>
    </main>
  `}function Z(e,t){const s=e??"code-vibes",o=t??"16";return x[s][o]}function I(e,t,s){const o=e||"-",n=t||"-",a=s?`${s} cards`:"-";return`Theme: ${o} | Player: ${n} | Board: ${a}`}const H="#game-back-button";function A(e){e.innerHTML=T(f()),P(e)}function P(e){const t=e.querySelector(H);t&&t.addEventListener("click",()=>{window.location.hash="#settings"})}const D="/projects/memory/assets/stadia_controller-CcsXEKot.svg",R="/projects/memory/assets/play-button-CNXT5xaq.svg";function z(){return`
  ...
  `}function U(){return`
    ...
    >
      <img src="${R}" alt="" aria-hidden="true" />
    </button>
  `}function j(){return`
    <img
    ...
    <main class="settings-screen" aria-labelledby="settings-title">
      <div class="settings-screen__canvas">
        <section class="settings-panel">
          ...
          ${c("Game themes",J,a2(e.theme))}
          ${c("Choose player",Q,o2(e.player))}
          ${c("Board size",K,i2(e.boardSize))}
        </section>

        <aside class="settings-preview">
          <img src="${t2}" alt="Game preview" />
        </aside>
  ...
  `}function a2(e){return u.map(t=>h("theme",t.value,t.label,e===t.value)).join("")}function o2(e){return C.map(t=>h("player",t.value,t.label,e===t.value)).join("")}function i2(e){return d.map(t=>h("boardSize",t.value,t.label,e===t.value)).join("")}function h(e,t,s,o){const n=o?" is-selected":"",a=o?r2():"";return`
    <li class="settings-option-item">
      <button
        ...
        data-value="${t}"
      >
        <img class="settings-option__marker" src="${o?Y:W}" alt="" aria-hidden="true" />
  ...
  `}function l2(e){return`
    <div class="settings-summary">
      ${l("Game theme",m(u,e.theme))}
      ${l("Player",m(C,e.player))}
      ${l("Board size",m(d,e.boardSize))}
    </div>
  ...
  `}function m2(){const e=g();return`
    <button
      ...
      ${e?"":"disabled"}
    >
      <img src="${s2}" alt="Start game" />
    </button>
  `}function m(e,t){if(!t)return"-";const s=e.find(o=>o.value===t);return s?s.label:"-"}const u2=".settings-option",C2="#start-game-button";function d2(e){v(e)}function v(e){e.innerHTML=n2(f()),g2(e),f2(e)}function g2(e){e.querySelectorAll(u2).forEach(s=>{s.addEventListener("click",()=>{h2(e,s.dataset.group,s.dataset.value)})})}function h2(e,t,s){!t||!s||(p2(t,s),v(e))}function p2(e,t){if(e==="theme"&&w(t)){b(t);return}if(e==="player"&&S(t)){y(t);return}e==="boardSize"&&L(t)&&_(t)}function f2(e){const t=e.querySelector(C2);t&&t.addEventListener("click",()=>{g()&&(window.location.hash="#game")})}function v2(e){p(e),window.addEventListener("hashchange",()=>{p(e)})}function p(e){const t=y2();if(t==="home"){F(e);return}if(t==="settings"){d2(e);return}b2(e)}function b2(e){if(!g()){window.location.hash="#settings";return}A(e)}function y2(){const e=window.location.hash.toLowerCase();return e==="#settings"?"settings":e==="#game"?"game":"home"}function _2(){const e=document.getElementById("app");e&&v2(e)}_2();
