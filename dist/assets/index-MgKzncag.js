(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))n(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function s(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerPolicy&&(r.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?r.credentials="include":a.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(a){if(a.ep)return;a.ep=!0;const r=s(a);fetch(a.href,r)}})();const O=[{value:"code-vibes",label:"Code vibes theme"},{value:"foods",label:"Foods theme"}],$=[{value:"blue",label:"Blue"},{value:"orange",label:"Orange"}],T=[{value:"16",label:"16 cards"},{value:"24",label:"24 cards"},{value:"36",label:"36 cards"}];let i={boardSize:null,player:null,theme:null};function l(){return{...i}}function I(e){i={...i,theme:e}}function P(e){i={...i,player:e}}function A(e){i={...i,boardSize:e}}function f(){return!!(i.theme&&i.player&&i.boardSize)}function x(e){return O.some(t=>t.value===e)}function H(e){return $.some(t=>t.value===e)}function R(e){return T.some(t=>t.value===e)}const Z="/projects/memory/assets/Code%20vibes%20theme_16-DnDZKwbK.svg",z="/projects/memory/assets/Code%20vibes%20theme_24-B6WV80WL.svg",F="/projects/memory/assets/Code%20vibes%20theme_36-DBGuI9rU.svg",N="/projects/memory/assets/Food_theme_16-C22FWGub.svg",j="/projects/memory/assets/Food_theme_24-CMaMg8km.svg",q="/projects/memory/assets/Food_theme_36-DpVdfDWc.svg",D="code-vibes",G={"code-vibes":{boardImages:{16:Z,24:z,36:F},cssModifierClass:"game-screen--code-vibes"},foods:{boardImages:{16:N,24:j,36:q},cssModifierClass:"game-screen--foods"}};function U(e){return e??D}function V(e){return G[U(e)].cssModifierClass}const K="data:image/svg+xml,%3csvg%20width='10'%20height='8'%20viewBox='0%200%2010%208'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M1.02564%208C0.74359%208%200.502137%207.90208%200.301282%207.70625C0.100427%207.51042%200%207.275%200%207V1C0%200.725%200.100427%200.489583%200.301282%200.29375C0.502137%200.0979167%200.74359%200%201.02564%200H6.66667C6.82906%200%206.98291%200.0354167%207.12821%200.10625C7.27351%200.177083%207.39316%200.275%207.48718%200.4L9.79487%203.4C9.93162%203.575%2010%203.775%2010%204C10%204.225%209.93162%204.425%209.79487%204.6L7.48718%207.6C7.39316%207.725%207.27351%207.82292%207.12821%207.89375C6.98291%207.96458%206.82906%208%206.66667%208H1.02564Z'%20fill='%232BB1FF'/%3e%3c/svg%3e",W="/projects/memory/assets/exitgame1-BZslv4aI.svg";function X(e){const t=V(e.theme),s=e.boardSize??"16",n=e2(s),a=Q(s),r=e.theme!=="foods",o=e.player==="orange"?" is-orange":" is-blue";return`
  ...
  `}function y2(e){return O.map(t=>h("theme",t.value,t.label,e===t.value)).join("")}function b2(e){return $.map(t=>h("player",t.value,t.label,e===t.value)).join("")}function w2(e){return T.map(t=>h("boardSize",t.value,t.label,e===t.value)).join("")}function h(e,t,s,n){const a=n?" is-selected":"",r=n?" is-visible":"",o=n?w:b,c=e==="theme"?` data-preview-theme="${t}"`:"";return`
  ...
  `}function S2(e,t){return`
    <div class="settings-footer__summary" aria-live="polite">
      <div class="settings-footer__fields">
        ...
        ${C("boardSize",B2(e.boardSize),e.boardSize!==null,!1)}
      </div>
      ${O2(t)}
    </div>
  ...
  `}function E2(e){return e?"Game theme":"Theme"}function L2(e){return e?e==="orange"?"Orange Player":"Blue Player":"Player"}function B2(e){return e?`Board-${e} Cards`:"Board size"}function O2(e){return`
    <button
  ...
  `}const k=".settings-option",$2='.settings-option[data-group="theme"]',T2=".settings-option__line",x2=".settings-option__marker",k2=".settings-footer__separator",M2=".settings-preview__image",M="#start-game-button",p="is-refreshing";function I2(e){e.innerHTML=v2(l()),P2(e),Z2(e),V2(e),m(e,l().theme)}function P2(e){e.querySelectorAll(k).forEach(s=>{s.addEventListener("click",()=>{A2(e,s.dataset.group,s.dataset.value)})})}function A2(e,t,s){!t||!s||(H2(t,s),R2(e,l()))}function H2(e,t){if(e==="theme"&&x(t)){I(t);return}if(e==="player"&&H(t)){P(t);return}e==="boardSize"&&R(t)&&A(t)}function R2(e,t){z2(e,t),N2(e,t),U2(e),m(e,t.theme)}function Z2(e){e.querySelectorAll($2).forEach(s=>{s.addEventListener("mouseenter",()=>{L(e,s.dataset.previewTheme)}),s.addEventListener("mouseleave",()=>{m(e,l().theme)}),s.addEventListener("focus",()=>{L(e,s.dataset.previewTheme)}),s.addEventListener("blur",()=>{m(e,l().theme)})})}function L(e,t){!t||!x(t)||m(e,t)}function m(e,t){const s=e.querySelector(M2);if(!s)return;const n=t==="foods"?s.dataset.previewFoods:s.dataset.previewCodeVibes||s.dataset.previewDefault;n&&(s.src=n)}function z2(e,t){e.querySelectorAll(k).forEach(n=>{const a=F2(t,n.dataset.group,n.dataset.value);n.classList.toggle("is-selected",a),n.querySelector(T2)?.classList.toggle("is-visible",a);const o=n.querySelector(x2);if(!o)return;const c=a?o.dataset.activeIcon:o.dataset.inactiveIcon;c&&(o.src=c)})}function F2(e,t,s){return!t||!s?!1:t==="theme"?e.theme===s:t==="player"?e.player===s:t==="boardSize"?e.boardSize===s:!1}function N2(e,t){g(e,"theme",t.theme!==null,q2(t.theme)),g(e,"player",t.player!==null,D2(t.player)),g(e,"boardSize",t.boardSize!==null,G2(t.boardSize))}function g(e,t,s,n){const a=e.querySelector(`[data-summary-group="${t}"]`);if(!a)return;const r=a.classList.contains("is-selected");a.classList.toggle("is-selected",s);const o=a.querySelector(k2);if(o){const v=s?o.dataset.separatorActive:o.dataset.separatorInactive;v&&(o.src=v)}const c=a.querySelector(`[data-summary-text="${t}"]`);let _=!1;c&&c.textContent!==n&&(c.textContent=n,_=!0),(s&&!r||_)&&j2(a)}function j2(e){e.classList.remove(p),window.requestAnimationFrame(()=>{e.classList.add(p),window.setTimeout(()=>{e.classList.remove(p)},240)})}function q2(e){return e?"Game theme":"Theme"}function D2(e){return e?e==="orange"?"Orange Player":"Blue Player":"Player"}function G2(e){return e?`Board-${e} Cards`:"Board size"}function U2(e){const t=e.querySelector(M);if(!t)return;const s=f();t.classList.toggle("is-ready",s),t.disabled=!s}function V2(e){const t=e.querySelector(M);t&&t.addEventListener("click",()=>{f()&&(window.location.hash="#game")})}function K2(e){B(e),window.addEventListener("hashchange",()=>{B(e)})}function B(e){const t=X2();if(t==="home"){m2(e);return}if(t==="settings"){I2(e);return}W2(e)}function W2(e){if(!f()){window.location.hash="#settings";return}s2(e)}function X2(){const e=window.location.hash.toLowerCase();return e==="#settings"?"settings":e==="#game"?"game":"home"}function Y2(){const e=document.getElementById("app");e&&K2(e)}Y2();
