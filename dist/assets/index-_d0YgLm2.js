(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))a(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const c of s.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&a(c)}).observe(document,{childList:!0,subtree:!0});function t(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerPolicy&&(s.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?s.credentials="include":r.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function a(r){if(r.ep)return;r.ep=!0;const s=t(r);fetch(r.href,s)}})();const P=[{value:"code-vibes",label:"Code vibes theme"},{value:"foods",label:"Foods theme"}],k=[{value:"blue",label:"Blue"},{value:"orange",label:"Orange"}],x=[{value:"16",label:"16 cards"},{value:"24",label:"24 cards"},{value:"36",label:"36 cards"}];let i={boardSize:null,player:null,theme:null};function l(){return{...i}}function Z(e){i={...i,theme:e}}function z(e){i={...i,player:e}}function X(e){i={...i,boardSize:e}}function m(){return!!(i.theme&&i.player&&i.boardSize)}function F(e){return P.some(n=>n.value===e)}function q(e){return k.some(n=>n.value===e)}function $(e){return x.some(n=>n.value===e)}let d=null;function J(e){d={...e}}function Q(){return d?{...d}:null}function e2(){return d!==null}function U(){d=null}function o(e,n){let t=e;return Object.entries(n).forEach(([a,r])=>{t=t.replaceAll(`{{${a}}}`,r)}),t}const n2="code-vibes",t2={"code-vibes":{cssModifierClass:"game-screen--code-vibes"},foods:{cssModifierClass:"game-screen--foods"}};function f(e){return e??n2}function a2(e){return t2[f(e)].cssModifierClass}const D=`<svg width="10" height="8" viewBox="0 0 10 8" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,r2="/projects/memory/assets/exitgame1-BZslv4aI.svg",H="/projects/memory/assets/back-to-game-button-Dy28tT7r.svg",s2="/projects/memory/assets/exit-game-button-CSFmJePI.svg",o2="/projects/memory/assets/exit-game-button-DxiUlG8b.svg",c2="/projects/memory/assets/exit-game-button-hover-CWKYXIiz.svg",i2="/projects/memory/assets/back-to-game-button-BckwOnvC.svg",l2="/projects/memory/assets/back-to-game-button-hover-CltZJA0Z.svg",d2="/projects/memory/assets/exit-game-button-overlay-BmTcSkCT.svg",m2="/projects/memory/assets/exit-game-button-overlay-hover-CHeUaH3n.svg",_2="/projects/memory/assets/Cards%205-DZnpmrpx.svg",u2="/projects/memory/assets/angular-card-CMiTHiGh.svg",C2="/projects/memory/assets/bootstrap-card-Rq83vZTa.svg",g2="/projects/memory/assets/css-card-Yna33ZIc.svg",p2="/projects/memory/assets/database-card-DZJGMO6r.svg",E2="/projects/memory/assets/django-card-zdDnWkPj.svg",f2="/projects/memory/assets/firebase-card-BGJGDkPQ.svg",S2="/projects/memory/assets/guthub-card-C0OAhCwn.svg",R2="/projects/memory/assets/html5-card-CuL2MCMe.svg",O2="/projects/memory/assets/js-card-vn5hBh96.svg",h2="/projects/memory/assets/node-card-Dum8zyHj.svg",v2="/projects/memory/assets/python-card-xA_4epsW.svg",A2="/projects/memory/assets/react-card-CIELOEMr.svg",y2="/projects/memory/assets/sass-card-DwnRYj6b.svg",b2="/projects/memory/assets/terminal-card-B7_Z2NcV.svg",T2="/projects/memory/assets/ts-card-BKPozS6g.svg",I2="/projects/memory/assets/vscode-card-fF042ORC.svg",L2="/projects/memory/assets/vue-card-BoB3VO2b.svg",M2="/projects/memory/assets/back-card-D-qRVjX3.svg",B2="/projects/memory/assets/brezel-card-CXqqkZs-.svg",w2="/projects/memory/assets/cake-card-BXMN5G8t.svg",N2="/projects/memory/assets/chicken-card-V3orblRE.svg",P2="/projects/memory/assets/chocolate-card-QAzOvrHx.svg",k2="/projects/memory/assets/corndog-card-CwpjZjE3.svg",x2="/projects/memory/assets/donut-card-C0Ssqpoo.svg",F2="/projects/memory/assets/hamburger-card-CjV68Ggw.svg",U2="/projects/memory/assets/icecream-card-CoO_ylkx.svg",D2="/projects/memory/assets/macron-card-D9lMrSKW.svg",H2="/projects/memory/assets/muffin-card-DO8Rb5nk.svg",G2="/projects/memory/assets/pizza-card-CCl09bmZ.svg",V2="/projects/memory/assets/pommes-card-KiUYGabn.svg",j2="/projects/memory/assets/pudding-card-Ct1M7kVT.svg",K2="/projects/memory/assets/salad-card-8HQ_A0VA.svg",Y2="/projects/memory/assets/sandwich-card-Z1FA70DW.svg",W2="/projects/memory/assets/sushi-card-DUXi4ArE.svg",Z2="/projects/memory/assets/tacco-card-D5AQdy9w.svg",z2="/projects/memory/assets/wrao-card-CLUKRYIs.svg",X2=`<main class="game-screen {{GAME_THEME_CLASS_NAME}} {{BOARD_SIZE_CLASS_NAME}}" aria-labelledby="game-title">
...
`,$2=`<div class="game-screen__hud game-screen__hud--foods">
...
`,J2=`<div class="game-screen__exit-modal" data-exit-modal hidden>
...
`,Q2=`<div class="game-screen__exit-modal game-screen__exit-modal--foods" data-exit-modal hidden>
  <div
...
`,ne=[u2,C2,g2,p2,E2,f2,S2,R2,O2,h2,v2,A2,y2,b2,T2,I2,L2],te=[B2,w2,N2,P2,k2,x2,F2,U2,D2,H2,G2,V2,j2,K2,Y2,W2,Z2,z2],G={"code-vibes":{backCardSprite:_2,faceIcons:ne},foods:{backCardSprite:M2,faceIcons:te}};function ae(e){const n=f(e.theme),t=a2(e.theme),a=e.boardSize??"16",r=ge(a),s=_e(a,n),c=e.player==="orange"?" is-orange":" is-blue",A=n==="foods"?oe(c):re(c);return o(X2,{BOARD_CARDS:s,BOARD_SIZE:a,BOARD_SIZE_CLASS_NAME:r,EXIT_MODAL_MARKUP:le(n),GAME_THEME_CLASS_NAME:t,HUD_MARKUP:A})}function re(e){const n=se();return o(q2,{EXIT_BUTTON_SRC:r2,PLAYER_LABEL_ICON:n,PLAYER_MARKER_CLASS_NAME:e})}function se(){return D.replace(/fill="#2BB1FF"/gi,'fill="currentColor"').trim()}function oe(e){const n=ce(),t=ie();return o($2,{FOODS_EXIT_HEADER_BUTTON_HOVER_SRC:c2,FOODS_EXIT_HEADER_BUTTON_SRC:o2,FOODS_PLAYER_MARKER_ICON:t,FOODS_SCORE_ICON:n,PLAYER_MARKER_CLASS_NAME:e})}function ce(){return S.replace(/<rect[^>]*fill="#097FC5"[^>]*\/>\s*/gi,"").replace(/fill="white"/gi,'fill="currentColor"').trim()}function ie(){return S.replace(/fill="#097FC5"/gi,'fill="currentColor"').trim()}function le(e){return e==="foods"?me():de()}function de(){return o(J2,{BACK_TO_GAME_BUTTON_SRC:H,EXIT_GAME_BUTTON_SRC:s2})}function me(){return o(Q2,{FOODS_BACK_TO_GAME_BUTTON_HOVER_SRC:l2,FOODS_BACK_TO_GAME_BUTTON_SRC:i2,FOODS_EXIT_OVERLAY_BUTTON_HOVER_SRC:m2,FOODS_EXIT_OVERLAY_BUTTON_SRC:d2})}function _e(e,n){const t=Number.parseInt(e,10),a=Number.isFinite(t)&&t>0?t:16,r=G[n],s=Math.floor(a/2),c=ue(s,n);return Ce([...c,...c]).map((Y,W)=>o(ee,{BACK_CARD_SPRITE:r.backCardSprite,CARD_ICON:Y,CARD_INDEX:String(W)})).join("")}function ue(e,n){const t=G[n].faceIcons;return Array.from({length:e},(a,r)=>t[r%t.length])}function Ce(e){const n=[...e];for(let t=n.length-1;t>0;t-=1){const a=Math.floor(Math.random()*(t+1));[n[t],n[a]]=[n[a],n[t]]}return n}function ge(e){return e==="24"?"game-screen--board-24":e==="36"?"game-screen--board-36":"game-screen--board-16"}const pe="#game-exit-button",Ee="[data-exit-modal]",fe="[data-exit-cancel]",Se="[data-exit-confirm]",Re=".game-screen",Oe="is-exit-modal-open",he=".game-card",ve="[data-current-player-marker]",R="flipped",O="is-matched",Ae=700,ye=320;function be(e){const n=l();e.innerHTML=ae(n),Te(e),Me(e,n.player??"blue")}function Te(e){const n=Ie(e);n&&Le(n)}function Ie(e){const n=e.querySelector(pe),t=e.querySelector(Ee),a=e.querySelector(fe),r=e.querySelector(Se),s=e.querySelector(Re);return!n||!t||!a||!r||!s?null:{exitButton:n,exitModal:t,backToGameButton:a,confirmExitButton:r,gameScreen:s}}function Le(e){e.exitButton.addEventListener("click",()=>{y(e,!0)}),e.backToGameButton.addEventListener("click",()=>{y(e,!1)}),e.confirmExitButton.addEventListener("click",()=>{window.location.hash="#settings"})}function y(e,n){e.exitModal.hidden=!n,e.gameScreen.classList.toggle(Oe,n)}function Me(e,n){const t=Be(e);if(t.length===0)return;const a=we(n);h(e,a),Ne(e,t,a)}function Be(e){return Array.from(e.querySelectorAll(he))}function we(e){return{currentPlayer:e,firstFlippedCard:null,secondFlippedCard:null,isTurnLocked:!1,scores:{blue:0,orange:0}}}function Ne(e,n,t){n.forEach(a=>{a.addEventListener("click",()=>{Pe(e,n.length,t,a)})})}function Pe(e,n,t,a){if(!ke(t,a)){if(V(a),!t.firstFlippedCard){t.firstFlippedCard=a;return}xe(t,a),Fe(e,n,t)}}function ke(e,n){return e.isTurnLocked||n.classList.contains(R)||n.classList.contains(O)}function xe(e,n){e.secondFlippedCard=n,e.isTurnLocked=!0}function Fe(e,n,t){if(Ue(t)){Ve(e,n,t);return}De(e,t)}function Ue(e){return!e.firstFlippedCard||!e.secondFlippedCard?!1:Ge(e.firstFlippedCard,e.secondFlippedCard)}function De(e,n){window.setTimeout(()=>{b(n.firstFlippedCard),b(n.secondFlippedCard),He(n),E(n),h(e,n)},Ae)}function b(e){e?.classList.contains(R)&&V(e)}function He(e){e.currentPlayer=e.currentPlayer==="blue"?"orange":"blue"}function V(e){e.classList.toggle(R)}function Ge(e,n){const t=e.dataset.cardIcon,a=n.dataset.cardIcon;return!!(t&&a&&t===a)}function Ve(e,n,t){const a=je(t);if(!a){E(t);return}Ke(a),Ye(t),E(t),h(e,t),We(e,n,t)}function je(e){return!e.firstFlippedCard||!e.secondFlippedCard?null:[e.firstFlippedCard,e.secondFlippedCard]}function Ke(e){e.forEach(n=>{n.classList.add(O),n.disabled=!0})}function Ye(e){e.scores[e.currentPlayer]+=1}function We(e,n,t){e.querySelectorAll(`.${O}`).length===n&&Ze(t)}function Ze(e){window.setTimeout(()=>{J(ze(e)),window.location.hash="#game-over"},ye)}function ze(e){return{blueScore:e.scores.blue,orangeScore:e.scores.orange}}function E(e){e.firstFlippedCard=null,e.secondFlippedCard=null,e.isTurnLocked=!1}function h(e,n){T(e,"blue",n.scores.blue),T(e,"orange",n.scores.orange);const t=e.querySelector(ve);t&&t.classList.toggle("is-orange",n.currentPlayer==="orange")}function T(e,n,t){const a=e.querySelectorAll(`[data-score-player="${n}"]`);a.length!==0&&a.forEach(r=>{r.textContent=String(t)})}const Xe="/projects/memory/assets/Confetti-Ze9Uy3By.svg",qe="/projects/memory/assets/home-button-DH4JdF9e.svg",$e="data:image/svg+xml,%3csvg%20width='272'%20height='310'%20viewBox='0%200%20272%20310'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cg%20filter='url(%23filter0_d_2258_3991)'%3e%3crect%20width='260'%20height='298'%20transform='translate(3%203)'%20fill='%23F7E6D5'/%3e%3cpath%20d='M58%20277C51.125%20277%2045.2396%20274.552%2040.3438%20269.656C35.4479%20264.76%2033%20258.875%2033%20252V227.312C33%20223.146%2033.9375%20219.292%2035.8125%20215.75C37.6875%20212.208%2040.1875%20209.188%2043.3125%20206.688C57.6875%20195.021%2068.4688%20183.25%2075.6562%20171.375C82.8438%20159.5%2087.8958%20148.875%2090.8125%20139.5H70.5C66.9583%20139.5%2063.9896%20138.302%2061.5938%20135.906C59.1979%20133.51%2058%20130.542%2058%20127C58%20123.458%2059.1979%20120.49%2061.5938%20118.094C63.9896%20115.698%2066.9583%20114.5%2070.5%20114.5H86.125C83.2083%20109.917%2080.9167%20105.021%2079.25%2099.8125C77.5833%2094.6042%2076.75%2089.0833%2076.75%2083.25C76.75%2067.625%2082.2188%2054.3438%2093.1562%2043.4062C104.094%2032.4688%20117.375%2027%20133%2027C148.625%2027%20161.906%2032.4688%20172.844%2043.4062C183.781%2054.3438%20189.25%2067.625%20189.25%2083.25C189.25%2089.0833%20188.417%2094.6042%20186.75%2099.8125C185.083%20105.021%20182.792%20109.917%20179.875%20114.5H195.5C199.042%20114.5%20202.01%20115.698%20204.406%20118.094C206.802%20120.49%20208%20123.458%20208%20127C208%20130.542%20206.802%20133.51%20204.406%20135.906C202.01%20138.302%20199.042%20139.5%20195.5%20139.5H175.188C178.104%20148.875%20183.156%20159.5%20190.344%20171.375C197.531%20183.25%20208.312%20195.021%20222.688%20206.688C225.812%20209.188%20228.312%20212.208%20230.188%20215.75C232.062%20219.292%20233%20223.146%20233%20227.312V252C233%20258.875%20230.552%20264.76%20225.656%20269.656C220.76%20274.552%20214.875%20277%20208%20277H58ZM58%20252H208V227C188.833%20212%20174.979%20196.531%20166.438%20180.594C157.896%20164.656%20152.167%20150.958%20149.25%20139.5H116.75C113.833%20150.958%20108.104%20164.656%2099.5625%20180.594C91.0208%20196.531%2077.1667%20212%2058%20227V252ZM133%20114.5C141.75%20114.5%20149.146%20111.479%20155.188%20105.438C161.229%2099.3958%20164.25%2092%20164.25%2083.25C164.25%2074.5%20161.229%2067.1042%20155.188%2061.0625C149.146%2055.0208%20141.75%2052%20133%2052C124.25%2052%20116.854%2055.0208%20110.812%2061.0625C104.771%2067.1042%20101.75%2074.5%20101.75%2083.25C101.75%2092%20104.771%2099.3958%20110.812%20105.438C116.854%20111.479%20124.25%20114.5%20133%20114.5Z'%20fill='%23097FC5'/%3e%3c/g%3e%3cdefs%3e%3cfilter%20id='filter0_d_2258_3991'%20x='0'%20y='0'%20width='272'%20height='310'%20filterUnits='userSpaceOnUse'%20color-interpolation-filters='sRGB'%3e%3cfeFlood%20flood-opacity='0'%20result='BackgroundImageFix'/%3e%3cfeColorMatrix%20in='SourceAlpha'%20type='matrix'%20values='0%200%200%200%200%200%200%200%200%200%200%200%200%200%200%200%200%200%20127%200'%20result='hardAlpha'/%3e%3cfeOffset%20dx='3'%20dy='3'/%3e%3cfeGaussianBlur%20stdDeviation='3'/%3e%3cfeComposite%20in2='hardAlpha'%20operator='out'/%3e%3cfeColorMatrix%20type='matrix'%20values='0%200%200%200%200%200%200%200%200%200%200%200%200%200%200%200%200%200%200.25%200'/%3e%3cfeBlend%20mode='normal'%20in2='BackgroundImageFix'%20result='effect1_dropShadow_2258_3991'/%3e%3cfeBlend%20mode='normal'%20in='SourceGraphic'%20in2='effect1_dropShadow_2258_3991'%20result='shape'/%3e%3c/filter%3e%3c/defs%3e%3c/svg%3e",Je="data:image/svg+xml,%3csvg%20width='272'%20height='310'%20viewBox='0%200%20272%20310'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cg%20filter='url(%23filter0_d_2258_3917)'%3e%3crect%20width='260'%20height='298'%20transform='translate(3%203)'%20fill='%23F7E6D5'/%3e%3cpath%20d='M58%20277C51.125%20277%2045.2396%20274.552%2040.3438%20269.656C35.4479%20264.76%2033%20258.875%2033%20252V227.312C33%20223.146%2033.9375%20219.292%2035.8125%20215.75C37.6875%20212.208%2040.1875%20209.188%2043.3125%20206.688C57.6875%20195.021%2068.4688%20183.25%2075.6562%20171.375C82.8438%20159.5%2087.8958%20148.875%2090.8125%20139.5H70.5C66.9583%20139.5%2063.9896%20138.302%2061.5938%20135.906C59.1979%20133.51%2058%20130.542%2058%20127C58%20123.458%2059.1979%20120.49%2061.5938%20118.094C63.9896%20115.698%2066.9583%20114.5%2070.5%20114.5H86.125C83.2083%20109.917%2080.9167%20105.021%2079.25%2099.8125C77.5833%2094.6042%2076.75%2089.0833%2076.75%2083.25C76.75%2067.625%2082.2188%2054.3438%2093.1562%2043.4062C104.094%2032.4688%20117.375%2027%20133%2027C148.625%2027%20161.906%2032.4688%20172.844%2043.4062C183.781%2054.3438%20189.25%2067.625%20189.25%2083.25C189.25%2089.0833%20188.417%2094.6042%20186.75%2099.8125C185.083%20105.021%20182.792%20109.917%20179.875%20114.5H195.5C199.042%20114.5%20202.01%20115.698%20204.406%20118.094C206.802%20120.49%20208%20123.458%20208%20127C208%20130.542%20206.802%20133.51%20204.406%20135.906C202.01%20138.302%20199.042%20139.5%20195.5%20139.5H175.188C178.104%20148.875%20183.156%20159.5%20190.344%20171.375C197.531%20183.25%20208.312%20195.021%20222.688%20206.688C225.812%20209.188%20228.312%20212.208%20230.188%20215.75C232.062%20219.292%20233%20223.146%20233%20227.312V252C233%20258.875%20230.552%20264.76%20225.656%20269.656C220.76%20274.552%20214.875%20277%20208%20277H58ZM58%20252H208V227C188.833%20212%20174.979%20196.531%20166.438%20180.594C157.896%20164.656%20152.167%20150.958%20149.25%20139.5H116.75C113.833%20150.958%20108.104%20164.656%2099.5625%20180.594C91.0208%20196.531%2077.1667%20212%2058%20227V252ZM133%20114.5C141.75%20114.5%20149.146%20111.479%20155.188%20105.438C161.229%2099.3958%20164.25%2092%20164.25%2083.25C164.25%2074.5%20161.229%2067.1042%20155.188%2061.0625C149.146%2055.0208%20141.75%2052%20133%2052C124.25%2052%20116.854%2055.0208%20110.812%2061.0625C104.771%2067.1042%20101.75%2074.5%20101.75%2083.25C101.75%2092%20104.771%2099.3958%20110.812%20105.438C116.854%20111.479%20124.25%20114.5%20133%20114.5Z'%20fill='%23F58E39'/%3e%3c/g%3e%3cdefs%3e%3cfilter%20id='filter0_d_2258_3917'%20x='0'%20y='0'%20width='272'%20height='310'%20filterUnits='userSpaceOnUse'%20color-interpolation-filters='sRGB'%3e%3cfeFlood%20flood-opacity='0'%20result='BackgroundImageFix'/%3e%3cfeColorMatrix%20in='SourceAlpha'%20type='matrix'%20values='0%200%200%200%200%200%200%200%200%200%200%200%200%200%200%200%200%200%20127%200'%20result='hardAlpha'/%3e%3cfeOffset%20dx='3'%20dy='3'/%3e%3cfeGaussianBlur%20stdDeviation='3'/%3e%3cfeComposite%20in2='hardAlpha'%20operator='out'/%3e%3cfeColorMatrix%20type='matrix'%20values='0%200%200%200%200%200%200%200%200%200%200%200%200%200%200%200%200%200%200.25%200'/%3e%3cfeBlend%20mode='normal'%20in2='BackgroundImageFix'%20result='effect1_dropShadow_2258_3917'/%3e%3cfeBlend%20mode='normal'%20in='SourceGraphic'%20in2='effect1_dropShadow_2258_3917'%20result='shape'/%3e%3c/filter%3e%3c/defs%3e%3c/svg%3e",Qe=`<main
...
<h2 class="game-over-screen__subtitle">Final score</h2>
{{SCORE_SUMMARY_MARKUP}}
`,t0=`{{WINNER_PREFIX_MARKUP}}
<p class="game-over-screen__winner-player {{WINNER_PLAYER_CLASS_NAME}}">
  {{WINNER_LABEL}}
</p>
{{PLAYER_ICON_MARKUP}}
`,a0=`<div class="game-over-screen__winner-icon">
  <img
...
`,r0=`<div class="game-over-screen__summary game-over-screen__summary--foods" aria-label="Final score">
  {{FOODS_ORANGE_SCORE_ROW}}
  {{FOODS_BLUE_SCORE_ROW}}
</div>
`,s0=`<div class="game-over-screen__summary" aria-label="Final score">
  {{CODE_VIBES_BLUE_SCORE_ROW}}
  {{CODE_VIBES_ORANGE_SCORE_ROW}}
</div>
`,o0=`<div class="game-over-screen__foods-score game-over-screen__foods-score--{{PLAYER_COLOR}}">
...
`,c0=`<div class="game-over-screen__player game-over-screen__player--{{PLAYER_COLOR}}">
  <span class="game-over-screen__icon" aria-hidden="true">{{PLAYER_LABEL_ICON}}</span>
  <span class="game-over-screen__name">{{PLAYER_NAME}}</span>
  <span class="game-over-screen__value">{{PLAYER_SCORE}}</span>
</div>
`;function i0(e,n){const t=f(n),a=t==="foods",r=O0(e),s=p0(e,t);return o(Qe,{BACK_HOME_BUTTON_IMAGE_CLASS_NAME:R0(a),BACK_HOME_BUTTON_SRC:S0(a),CONFETTI_MARKUP:a?"":d0(),SCORE_SUMMARY_MARKUP:s,THEME_CLASS_NAME:a?"game-over-screen--foods":"game-over-screen--code-vibes",WINNER_CONTENT_MARKUP:l0(r,a,s)})}function l0(e,n,t){return n?_0(e):m0(e,t)}function d0(){return o(e0,{CONFETTI_SRC:Xe})}function m0(e,n){return o(n0,{SCORE_SUMMARY_MARKUP:n,WINNER_LABEL:e.label,WINNER_PLAYER_CLASS_NAME:e.className,WINNER_PREFIX_MARKUP:e.isDraw?"":'<p class="game-over-screen__winner-prefix">the winner is</p>'})}function _0(e){return o(t0,{PLAYER_ICON_MARKUP:u0(e),WINNER_LABEL:e.label,WINNER_PLAYER_CLASS_NAME:e.className,WINNER_PREFIX_MARKUP:e.isDraw?"":'<p class="game-over-screen__winner-prefix">The winner is</p>'})}function u0(e){if(e.isDraw)return"";const n=e.className==="game-over-screen__winner-player--orange";return o(a0,{WINNER_ICON_ALT:n?"Orange player icon":"Blue player icon",WINNER_ICON_SRC:n?Je:$e})}function C0(){return D.replace(/fill="#2BB1FF"/gi,'fill="currentColor"').trim()}function g0(){return S.replace(/fill="#097FC5"/gi,'fill="currentColor"').trim()}function p0(e,n){return n==="foods"?E0(e):f0(e)}function E0(e){const n=g0();return o(r0,{FOODS_BLUE_SCORE_ROW:I("blue",e.blueScore,n),FOODS_ORANGE_SCORE_ROW:I("orange",e.orangeScore,n)})}function I(e,n,t){return o(o0,{PLAYER_COLOR:e,PLAYER_LABEL_ICON:t,PLAYER_SCORE:String(n)})}function f0(e){const n=C0();return o(s0,{CODE_VIBES_BLUE_SCORE_ROW:L("blue","Blue",e.blueScore,n),CODE_VIBES_ORANGE_SCORE_ROW:L("orange","Orange",e.orangeScore,n)})}function L(e,n,t,a){return o(c0,{PLAYER_COLOR:e,PLAYER_LABEL_ICON:a,PLAYER_NAME:n,PLAYER_SCORE:String(t)})}function S0(e){return e?qe:H}function R0(e){return e?"game-over-screen__back-home-button-image game-over-screen__back-home-button-image--foods":"game-over-screen__back-home-button-image"}function O0(e){return e.blueScore>e.orangeScore?{isDraw:!1,className:"game-over-screen__winner-player--blue",label:"BLUE PLAYER"}:e.orangeScore>e.blueScore?{isDraw:!1,className:"game-over-screen__winner-player--orange",label:"ORANGE PLAYER"}:{isDraw:!0,className:"game-over-screen__winner-player--draw",label:"DRAW"}}const h0=3500,v0="[data-game-over-screen]",A0="[data-back-home-button]",y0="is-winner-visible";function b0(e){const n=Q();if(!n){window.location.hash="#game";return}e.innerHTML=i0(n,l().theme),T0(e),I0(e)}function T0(e){e.querySelector(A0)?.addEventListener("click",()=>{U(),window.location.hash="#home"})}function I0(e){const n=e.querySelector(v0);n&&window.setTimeout(()=>{L0(e,n)},h0)}function L0(e,n){!e.isConnected||window.location.hash!=="#game-over"||n.classList.add(y0)}const M0="/projects/memory/assets/stadia_controller-CcsXEKot.svg",B0="/projects/memory/assets/play-button-CNXT5xaq.svg",w0=`<main class="home-screen" aria-labelledby="home-title">
...
`,W0=`<section class="settings-group">
...
`,Z0=`<li class="settings-option-item">
  <button
...
`,z0=`<div class="settings-footer__summary" aria-live="polite">
  <div class="settings-footer__fields">
    {{FOOTER_FIELDS_MARKUP}}
  </div>
  {{START_BUTTON_MARKUP}}
</div>
`,X0=`<div class="settings-footer__item{{SELECTED_CLASS}}" data-summary-group="{{SUMMARY_GROUP}}">
...
`;function J0(e){const n=e.theme!==null&&e.player!==null&&e.boardSize!==null,t=e.theme==="foods"?w:u;return o(Y0,{BOARD_SIZE_GROUP_MARKUP:C("Board size",U0,nn(e.boardSize)),FOOTER_SUMMARY_MARKUP:tn(e,n),PLAYER_GROUP_MARKUP:C("Choose player",H0,en(e.player)),PREVIEW_CODE_VIBES_SRC:u,PREVIEW_DEFAULT_SRC:u,PREVIEW_FOODS_SRC:w,PREVIEW_IMAGE_SRC:t,THEME_GROUP_MARKUP:C("Game themes",D0,Q0(e.theme))})}function C(e,n,t){return o(W0,{GROUP_ICON_SRC:n,GROUP_TITLE:e,OPTIONS_MARKUP:t})}function Q0(e){return P.map(n=>v("theme",n.value,n.label,e===n.value)).join("")}function en(e){return k.map(n=>v("player",n.value,n.label,e===n.value)).join("")}function nn(e){return x.map(n=>v("boardSize",n.value,n.label,e===n.value)).join("")}function v(e,n,t,a){const r=e==="theme"?` data-preview-theme="${n}"`:"";return o(Z0,{MARKER_ACTIVE_ICON_SRC:B,MARKER_ICON_SRC:a?B:M,MARKER_INACTIVE_ICON_SRC:M,OPTION_GROUP:e,OPTION_LABEL:t,OPTION_VALUE:n,PREVIEW_THEME_ATTRIBUTE:r,SELECTED_CLASS:a?" is-selected":"",SELECTED_LINE_ICON_SRC:j0,VISIBLE_LINE_CLASS:a?" is-visible":""})}function tn(e,n){return o(z0,{FOOTER_FIELDS_MARKUP:an(e),START_BUTTON_MARKUP:ln(n)})}function an(e){return[g("theme",sn(e.theme),e.theme!==null,!0),g("player",on(e.player),e.player!==null,!0),g("boardSize",cn(e.boardSize),e.boardSize!==null,!1)].join("")}function g(e,n,t,a){return o(X0,{SELECTED_CLASS:t?" is-selected":"",SEPARATOR_MARKUP:a?rn():"",SUMMARY_GROUP:e,SUMMARY_TEXT:n})}function rn(){return o(q0,{SEPARATOR_ACTIVE_SRC:G0,SEPARATOR_LINE_SRC:V0})}function sn(e){return e?"Game theme":"Theme"}function on(e){return e?e==="orange"?"Orange Player":"Blue Player":"Player"}function cn(e){return e?`Board-${e} Cards`:"Board size"}function ln(e){return o($0,{DISABLED_ATTRIBUTE:e?"":" disabled",READY_CLASS:e?" is-ready":"",START_BUTTON_IMAGE_SRC:K0})}const j=".settings-option",dn='.settings-option[data-group="theme"]',mn=".settings-option__line",_n=".settings-option__marker",un=".settings-footer__separator",Cn=".settings-preview__image",K="#start-game-button",p="is-refreshing";function gn(e){e.innerHTML=J0(l()),pn(e),An(e),Wn(e),_(e,l().theme)}function pn(e){e.querySelectorAll(j).forEach(t=>{t.addEventListener("click",()=>{En(e,t.dataset.group,t.dataset.value)})})}function En(e,n,t){!n||!t||(fn(n,t),vn(e,l()))}function fn(e,n){const t=Sn(e);t&&t(n)}function Sn(e){return e==="theme"?Rn:e==="player"?On:e==="boardSize"?hn:null}function Rn(e){F(e)&&Z(e)}function On(e){q(e)&&z(e)}function hn(e){$(e)&&X(e)}function vn(e,n){Tn(e,n),Nn(e,n),Yn(e),_(e,n.theme)}function An(e){e.querySelectorAll(dn).forEach(t=>{yn(e,t)})}function yn(e,n){const t=()=>bn(e,n.dataset.previewTheme),a=()=>_(e,l().theme);n.addEventListener("mouseenter",t),n.addEventListener("mouseleave",a),n.addEventListener("focus",t),n.addEventListener("blur",a)}function bn(e,n){!n||!F(n)||_(e,n)}function _(e,n){const t=e.querySelector(Cn);if(!t)return;const a=n==="foods"?t.dataset.previewFoods:t.dataset.previewCodeVibes||t.dataset.previewDefault;a&&(t.src=a)}function Tn(e,n){e.querySelectorAll(j).forEach(a=>{In(a,n)})}function In(e,n){const t=Bn(n,e.dataset.group,e.dataset.value);e.classList.toggle("is-selected",t),Ln(e,t),Mn(e,t)}function Ln(e,n){e.querySelector(mn)?.classList.toggle("is-visible",n)}function Mn(e,n){const t=e.querySelector(_n);if(!t)return;const a=n?t.dataset.activeIcon:t.dataset.inactiveIcon;a&&(t.src=a)}function Bn(e,n,t){return!n||!t?!1:wn(e,n)===t}function wn(e,n){return n==="theme"?e.theme:n==="player"?e.player:n==="boardSize"?e.boardSize:null}function Nn(e,n){Pn(n).forEach(([a,r,s])=>{kn(e,a,r,s)})}function Pn(e){return[["theme",e.theme!==null,Vn(e.theme)],["player",e.player!==null,jn(e.player)],["boardSize",e.boardSize!==null,Kn(e.boardSize)]]}function kn(e,n,t,a){const r=e.querySelector(`[data-summary-group="${n}"]`);if(!r)return;const s=xn(r,t);Fn(r,t);const c=Dn(r,n,a);Hn(t,s,c)&&Gn(r)}function xn(e,n){const t=e.classList.contains("is-selected");return e.classList.toggle("is-selected",n),t}function Fn(e,n){const t=e.querySelector(un),a=Un(t,n);t&&a&&(t.src=a)}function Un(e,n){if(e)return n?e.dataset.separatorActive:e.dataset.separatorInactive}function Dn(e,n,t){const a=e.querySelector(`[data-summary-text="${n}"]`);return!a||a.textContent===t?!1:(a.textContent=t,!0)}function Hn(e,n,t){return e&&!n||t}function Gn(e){e.classList.remove(p),window.requestAnimationFrame(()=>{e.classList.add(p),window.setTimeout(()=>{e.classList.remove(p)},240)})}function Vn(e){return e?"Game theme":"Theme"}function jn(e){return e?e==="orange"?"Orange Player":"Blue Player":"Player"}function Kn(e){return e?`Board-${e} Cards`:"Board size"}function Yn(e){const n=e.querySelector(K);if(!n)return;const t=m();n.classList.toggle("is-ready",t),n.disabled=!t}function Wn(e){const n=e.querySelector(K);n&&n.addEventListener("click",Zn)}function Zn(){m()&&(U(),window.location.hash="#game")}function zn(e){N(e),window.addEventListener("hashchange",()=>{N(e)})}function N(e){const n=$n(),t=Qn[n];t(e)}function Xn(e){if(!m()){window.location.hash="#settings";return}be(e)}function qn(e){if(!m()){window.location.hash="#settings";return}if(!e2()){window.location.hash="#game";return}b0(e)}function $n(){const e=window.location.hash.toLowerCase();return Jn[e]??"home"}const Jn={"#game":"game","#game-over":"game-over","#home":"home","#settings":"settings"},Qn={game:Xn,"game-over":qn,home:k0,settings:gn};function et(){const e=document.getElementById("app");e&&zn(e)}et();
