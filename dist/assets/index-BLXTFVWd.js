(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))o(n);new MutationObserver(n=>{for(const a of n)if(a.type==="childList")for(const r of a.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&o(r)}).observe(document,{childList:!0,subtree:!0});function s(n){const a={};return n.integrity&&(a.integrity=n.integrity),n.referrerPolicy&&(a.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?a.credentials="include":n.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function o(n){if(n.ep)return;n.ep=!0;const a=s(n);fetch(n.href,a)}})();const u=[{value:"code-vibes",label:"Code vibes theme"},{value:"foods",label:"Foods theme"}],m=[{value:"blue",label:"Blue"},{value:"orange",label:"Orange"}],d=[{value:"16",label:"16 cards"},{value:"24",label:"24 cards"},{value:"36",label:"36 cards"}];let i={boardSize:null,player:null,theme:null};function f(){return{...i}}function b(e){i={...i,theme:e}}function y(e){i={...i,player:e}}function _(e){i={...i,boardSize:e}}function g(){return!!(i.theme&&i.player&&i.boardSize)}function w(e){return u.some(t=>t.value===e)}function S(e){return m.some(t=>t.value===e)}function k(e){return d.some(t=>t.value===e)}const B="/projects/memory/assets/Code%20vibes%20theme_16-DnDZKwbK.svg",O="/projects/memory/assets/Code%20vibes%20theme_24-B6WV80WL.svg",L="/projects/memory/assets/Code%20vibes%20theme_36-DBGuI9rU.svg",E="/projects/memory/assets/Food_theme_16-C22FWGub.svg",$="/projects/memory/assets/Food_theme_24-CMaMg8km.svg",M="/projects/memory/assets/Food_theme_36-DpVdfDWc.svg",T={"code-vibes":{16:B,24:O,36:L},foods:{16:E,24:$,36:M}};function x(e){return`
    ...
    <main class="settings-screen" aria-labelledby="settings-title">
      <div class="settings-screen__canvas">
        <section class="settings-panel">
          ...
          ${c("Game themes",J,n2(e.theme))}
          ${c("Choose player",Q,a2(e.player))}
          ${c("Board size",K,o2(e.boardSize))}
        </section>

        <aside class="settings-preview">
          <img src="${e2}" alt="Game preview" />
        </aside>
  ...
  `}function n2(e){return u.map(t=>h("theme",t.value,t.label,e===t.value,!0)).join("")}function a2(e){return m.map(t=>h("player",t.value,t.label,e===t.value)).join("")}function o2(e){return d.map(t=>h("boardSize",t.value,t.label,e===t.value)).join("")}function h(e,t,s,o,n=!1){const a=o?" is-selected":"",r=n&&o?i2():"";return`
  ...
  `}function i2(){return`
    <img
      ...
      aria-hidden="true"
    />
  `}function r2(e){return`
    <div class="settings-summary">
      ${l("Game theme",C(u,e.theme))}
      ${l("Player",C(m,e.player))}
      ${l("Board size",C(d,e.boardSize))}
    </div>
  ...
  `}function c2(){const e=g();return`
    <button
      ...
      ${e?"":"disabled"}
    >
      <img src="${t2}" alt="Start game" />
    </button>
  `}function C(e,t){if(!t)return"-";const s=e.find(o=>o.value===t);return s?s.label:"-"}const l2=".settings-option",C2="#start-game-button";function u2(e){v(e)}function v(e){e.innerHTML=s2(f()),m2(e),h2(e)}function m2(e){e.querySelectorAll(l2).forEach(s=>{s.addEventListener("click",()=>{d2(e,s.dataset.group,s.dataset.value)})})}function d2(e,t,s){!t||!s||(g2(t,s),v(e))}function g2(e,t){if(e==="theme"&&w(t)){b(t);return}if(e==="player"&&S(t)){y(t);return}e==="boardSize"&&k(t)&&_(t)}function h2(e){const t=e.querySelector(C2);t&&t.addEventListener("click",()=>{g()&&(window.location.hash="#game")})}function p2(e){p(e),window.addEventListener("hashchange",()=>{p(e)})}function p(e){const t=v2();if(t==="home"){V(e);return}if(t==="settings"){u2(e);return}f2(e)}function f2(e){if(!g()){window.location.hash="#settings";return}A(e)}function v2(){const e=window.location.hash.toLowerCase();return e==="#settings"?"settings":e==="#game"?"game":"home"}function b2(){const e=document.getElementById("app");e&&p2(e)}b2();
