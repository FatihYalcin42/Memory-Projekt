(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&a(o)}).observe(document,{childList:!0,subtree:!0});function s(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(n){if(n.ep)return;n.ep=!0;const r=s(n);fetch(n.href,r)}})();const F=[{value:"code-vibes",label:"Code vibes theme"},{value:"foods",label:"Foods theme"}],P=[{value:"blue",label:"Blue"},{value:"orange",label:"Orange"}],j=[{value:"16",label:"16 cards"},{value:"24",label:"24 cards"},{value:"36",label:"36 cards"}];let i={boardSize:null,player:null,theme:null};function l(){return{...i}}function z(e){i={...i,theme:e}}function V(e){i={...i,player:e}}function U(e){i={...i,boardSize:e}}function g(){return!!(i.theme&&i.player&&i.boardSize)}function H(e){return F.some(t=>t.value===e)}function W(e){return P.some(t=>t.value===e)}function Y(e){return j.some(t=>t.value===e)}let d=null;function K(e){d={...e}}function X(){return d?{...d}:null}function J(){return d!==null}function N(){d=null}const Q="/projects/memory/assets/Code%20vibes%20theme_16-DnDZKwbK.svg",e2="/projects/memory/assets/Code%20vibes%20theme_24-B6WV80WL.svg",t2="/projects/memory/assets/Code%20vibes%20theme_36-DBGuI9rU.svg",s2="/projects/memory/assets/Food_theme_16-C22FWGub.svg",a2="/projects/memory/assets/Food_theme_24-CMaMg8km.svg",n2="/projects/memory/assets/Food_theme_36-DpVdfDWc.svg",r2="code-vibes",o2={"code-vibes":{boardImages:{16:Q,24:e2,36:t2},cssModifierClass:"game-screen--code-vibes"},foods:{boardImages:{16:s2,24:a2,36:n2},cssModifierClass:"game-screen--foods"}};function c2(e){return e??r2}function i2(e){return o2[c2(e)].cssModifierClass}const D=`<svg width="10" height="8" viewBox="0 0 10 8" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,l2="/projects/memory/assets/exitgame1-BZslv4aI.svg",G="/projects/memory/assets/back-to-game-button-Dy28tT7r.svg",d2="/projects/memory/assets/exit-game-button-CSFmJePI.svg",m2="/projects/memory/assets/Cards%205-DZnpmrpx.svg",u2="/projects/memory/assets/angular-card-CMiTHiGh.svg",p2="/projects/memory/assets/bootstrap-card-Rq83vZTa.svg",g2="/projects/memory/assets/css-card-Yna33ZIc.svg",C2="/projects/memory/assets/database-card-DZJGMO6r.svg",f2="/projects/memory/assets/django-card-zdDnWkPj.svg",_2="/projects/memory/assets/firebase-card-BGJGDkPQ.svg",h2="/projects/memory/assets/guthub-card-C0OAhCwn.svg",v2="/projects/memory/assets/html5-card-CuL2MCMe.svg",y2="/projects/memory/assets/js-card-vn5hBh96.svg",b2="/projects/memory/assets/node-card-Dum8zyHj.svg",S2="/projects/memory/assets/python-card-xA_4epsW.svg",w2="/projects/memory/assets/react-card-CIELOEMr.svg",E2="/projects/memory/assets/sass-card-DwnRYj6b.svg",L2="/projects/memory/assets/terminal-card-B7_Z2NcV.svg",O2="/projects/memory/assets/ts-card-BKPozS6g.svg",T2="/projects/memory/assets/vscode-card-fF042ORC.svg",B2="/projects/memory/assets/vue-card-BoB3VO2b.svg",O=[u2,p2,g2,C2,f2,_2,h2,v2,y2,b2,S2,w2,E2,L2,O2,T2,B2];function I2(e){const t=i2(e.theme),s=e.boardSize??"16",a=P2(s),n=A2(s),r=e.theme!=="foods",o=e.player==="orange"?" is-orange":" is-blue";return`
  ...
  `}function A2(e){const t=Number.parseInt(e,10),s=Number.isFinite(t)&&t>0?t:16,a=Math.floor(s/2),n=R2(a);return F2([...n,...n]).map((o,c)=>`
    ...
    `).join("")}function R2(e){return Array.from({length:e},(t,s)=>O[s%O.length])}function F2(e){const t=[...e];for(let s=t.length-1;s>0;s-=1){const a=Math.floor(Math.random()*(s+1));[t[s],t[a]]=[t[a],t[s]]}return t}function P2(e){return e==="24"?"game-screen--board-24":e==="36"?"game-screen--board-36":"game-screen--board-16"}const j2="#game-exit-button",H2="[data-exit-modal]",N2="[data-exit-cancel]",D2="[data-exit-confirm]",G2=".game-screen",T="is-exit-modal-open",Z2=".game-card",q2="[data-current-player-marker]",u="flipped",p="is-matched",z2=700,V2=320;function U2(e){const t=l();e.innerHTML=I2(t),W2(e),Y2(e,t.player??"blue")}function W2(e){const t=e.querySelector(j2),s=e.querySelector(H2),a=e.querySelector(N2),n=e.querySelector(D2),r=e.querySelector(G2);if(!t||!s||!a||!n||!r)return;const o=()=>{s.hidden=!1,r.classList.add(T)},c=()=>{s.hidden=!0,r.classList.remove(T)};t.addEventListener("click",()=>{o()}),a.addEventListener("click",()=>{c()}),n.addEventListener("click",()=>{window.location.hash="#settings"})}function Y2(e,t){const s=Array.from(e.querySelectorAll(Z2));if(s.length===0)return;const a={currentPlayer:t,firstFlippedCard:null,secondFlippedCard:null,isTurnLocked:!1,scores:{blue:0,orange:0}};S(e,a),s.forEach(n=>{n.addEventListener("click",()=>{K2(e,s.length,a,n)})})}function K2(e,t,s,a){if(s.isTurnLocked||a.classList.contains(u)||a.classList.contains(p))return;if(C(a),!s.firstFlippedCard){s.firstFlippedCard=a;return}if(s.secondFlippedCard=a,s.isTurnLocked=!0,X2(s.firstFlippedCard,s.secondFlippedCard)){J2(e,t,s);return}window.setTimeout(()=>{s.firstFlippedCard&&s.firstFlippedCard.classList.contains(u)&&C(s.firstFlippedCard),s.secondFlippedCard&&s.secondFlippedCard.classList.contains(u)&&C(s.secondFlippedCard),s.currentPlayer=s.currentPlayer==="blue"?"orange":"blue",b(s),S(e,s)},z2)}function C(e){e.classList.toggle(u)}function X2(e,t){const s=e.dataset.cardIcon,a=t.dataset.cardIcon;return!!(s&&a&&s===a)}function J2(e,t,s){const a=s.firstFlippedCard,n=s.secondFlippedCard;if(!a||!n){b(s);return}a.classList.add(p),n.classList.add(p),a.disabled=!0,n.disabled=!0,s.scores[s.currentPlayer]+=1,b(s),S(e,s),e.querySelectorAll(`.${p}`).length===t&&window.setTimeout(()=>{K({blueScore:s.scores.blue,orangeScore:s.scores.orange}),window.location.hash="#game-over"},V2)}function b(e){e.firstFlippedCard=null,e.secondFlippedCard=null,e.isTurnLocked=!1}function S(e,t){B(e,"blue",t.scores.blue),B(e,"orange",t.scores.orange);const s=e.querySelector(q2);s&&s.classList.toggle("is-orange",t.currentPlayer==="orange")}function B(e,t,s){const a=e.querySelectorAll(`[data-score-player="${t}"]`);a.length!==0&&a.forEach(n=>{n.textContent=String(s)})}const Q2="/projects/memory/assets/Confetti-Ze9Uy3By.svg";function ee(e){const t=te(),s=ae(e),a=se(e,t);return`
    <main
  ...
  `}function te(){return D.replace(/fill="#2BB1FF"/gi,'fill="currentColor"').trim()}function se(e,t){return`
  ...
  `}function ae(e){return e.blueScore>e.orangeScore?{className:"game-over-screen__winner-player--blue",label:"BLUE PLAYER"}:e.orangeScore>e.blueScore?{className:"game-over-screen__winner-player--orange",label:"ORANGE PLAYER"}:{className:"game-over-screen__winner-player--draw",label:"DRAW"}}const ne=2200,re="[data-game-over-screen]",oe="[data-back-home-button]",ce="is-winner-visible";function ie(e){const t=X();if(!t){window.location.hash="#game";return}e.innerHTML=ee(t),e.querySelector(oe)?.addEventListener("click",()=>{N(),window.location.hash="#home"});const a=e.querySelector(re);a&&window.setTimeout(()=>{!e.isConnected||window.location.hash!=="#game-over"||a.classList.add(ce)},ne)}const le="/projects/memory/assets/stadia_controller-CcsXEKot.svg",I="/projects/memory/assets/play-button-CNXT5xaq.svg";function de(){return`
  ...
  `}function Le(e){return F.map(t=>w("theme",t.value,t.label,e===t.value)).join("")}function Oe(e){return P.map(t=>w("player",t.value,t.label,e===t.value)).join("")}function Te(e){return j.map(t=>w("boardSize",t.value,t.label,e===t.value)).join("")}function w(e,t,s,a){const n=a?" is-selected":"",r=a?" is-visible":"",o=a?x:k,c=e==="theme"?` data-preview-theme="${t}"`:"";return`
  ...
  `}const Z=".settings-option",$e='.settings-option[data-group="theme"]',Ae=".settings-option__line",Re=".settings-option__marker",Fe=".settings-footer__separator",Pe=".settings-preview__image",q="#start-game-button",v="is-refreshing";function je(e){e.innerHTML=Ee(l()),He(e),Ze(e),Je(e),m(e,l().theme)}function He(e){e.querySelectorAll(Z).forEach(s=>{s.addEventListener("click",()=>{Ne(e,s.dataset.group,s.dataset.value)})})}function Ne(e,t,s){!t||!s||(De(t,s),Ge(e,l()))}function De(e,t){if(e==="theme"&&H(t)){z(t);return}if(e==="player"&&W(t)){V(t);return}e==="boardSize"&&Y(t)&&U(t)}function Ge(e,t){qe(e,t),Ve(e,t),Xe(e),m(e,t.theme)}function Ze(e){e.querySelectorAll($e).forEach(s=>{s.addEventListener("mouseenter",()=>{A(e,s.dataset.previewTheme)}),s.addEventListener("mouseleave",()=>{m(e,l().theme)}),s.addEventListener("focus",()=>{A(e,s.dataset.previewTheme)}),s.addEventListener("blur",()=>{m(e,l().theme)})})}function A(e,t){!t||!H(t)||m(e,t)}function m(e,t){const s=e.querySelector(Pe);if(!s)return;const a=t==="foods"?s.dataset.previewFoods:s.dataset.previewCodeVibes||s.dataset.previewDefault;a&&(s.src=a)}function qe(e,t){e.querySelectorAll(Z).forEach(a=>{const n=ze(t,a.dataset.group,a.dataset.value);a.classList.toggle("is-selected",n),a.querySelector(Ae)?.classList.toggle("is-visible",n);const o=a.querySelector(Re);if(!o)return;const c=n?o.dataset.activeIcon:o.dataset.inactiveIcon;c&&(o.src=c)})}function ze(e,t,s){return!t||!s?!1:t==="theme"?e.theme===s:t==="player"?e.player===s:t==="boardSize"?e.boardSize===s:!1}function Ve(e,t){y(e,"theme",t.theme!==null,We(t.theme)),y(e,"player",t.player!==null,Ye(t.player)),y(e,"boardSize",t.boardSize!==null,Ke(t.boardSize))}function y(e,t,s,a){const n=e.querySelector(`[data-summary-group="${t}"]`);if(!n)return;const r=n.classList.contains("is-selected");n.classList.toggle("is-selected",s);const o=n.querySelector(Fe);if(o){const L=s?o.dataset.separatorActive:o.dataset.separatorInactive;L&&(o.src=L)}const c=n.querySelector(`[data-summary-text="${t}"]`);let E=!1;c&&c.textContent!==a&&(c.textContent=a,E=!0),(s&&!r||E)&&Ue(n)}function Ue(e){e.classList.remove(v),window.requestAnimationFrame(()=>{e.classList.add(v),window.setTimeout(()=>{e.classList.remove(v)},240)})}function We(e){return e?"Game theme":"Theme"}function Ye(e){return e?e==="orange"?"Orange Player":"Blue Player":"Player"}function Ke(e){return e?`Board-${e} Cards`:"Board size"}function Xe(e){const t=e.querySelector(q);if(!t)return;const s=g();t.classList.toggle("is-ready",s),t.disabled=!s}function Je(e){const t=e.querySelector(q);t&&t.addEventListener("click",()=>{g()&&(N(),window.location.hash="#game")})}function Qe(e){R(e),window.addEventListener("hashchange",()=>{R(e)})}function R(e){const t=s0();if(t==="home"){Ce(e);return}if(t==="settings"){je(e);return}if(t==="game-over"){t0(e);return}e0(e)}function e0(e){if(!g()){window.location.hash="#settings";return}U2(e)}function t0(e){if(!g()){window.location.hash="#settings";return}if(!J()){window.location.hash="#game";return}ie(e)}function s0(){const e=window.location.hash.toLowerCase();return e==="#settings"?"settings":e==="#game"?"game":e==="#game-over"?"game-over":"home"}function a0(){const e=document.getElementById("app");e&&Qe(e)}a0();
