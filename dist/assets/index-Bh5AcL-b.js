(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function a(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(n){if(n.ep)return;n.ep=!0;const r=a(n);fetch(n.href,r)}})();const F=[{value:"code-vibes",label:"Code vibes theme"},{value:"foods",label:"Foods theme"}],P=[{value:"blue",label:"Blue"},{value:"orange",label:"Orange"}],j=[{value:"16",label:"16 cards"},{value:"24",label:"24 cards"},{value:"36",label:"36 cards"}];let i={boardSize:null,player:null,theme:null};function l(){return{...i}}function z(e){i={...i,theme:e}}function V(e){i={...i,player:e}}function U(e){i={...i,boardSize:e}}function g(){return!!(i.theme&&i.player&&i.boardSize)}function D(e){return F.some(t=>t.value===e)}function W(e){return P.some(t=>t.value===e)}function Y(e){return j.some(t=>t.value===e)}let d=null;function K(e){d={...e}}function X(){return d?{...d}:null}function J(){return d!==null}function H(){d=null}const Q="/projects/memory/assets/Code%20vibes%20theme_16-DnDZKwbK.svg",e2="/projects/memory/assets/Code%20vibes%20theme_24-B6WV80WL.svg",t2="/projects/memory/assets/Code%20vibes%20theme_36-DBGuI9rU.svg",a2="/projects/memory/assets/Food_theme_16-C22FWGub.svg",s2="/projects/memory/assets/Food_theme_24-CMaMg8km.svg",n2="/projects/memory/assets/Food_theme_36-DpVdfDWc.svg",r2="code-vibes",o2={"code-vibes":{boardImages:{16:Q,24:e2,36:t2},cssModifierClass:"game-screen--code-vibes"},foods:{boardImages:{16:a2,24:s2,36:n2},cssModifierClass:"game-screen--foods"}};function c2(e){return e??r2}function i2(e){return o2[c2(e)].cssModifierClass}const N=`<svg width="10" height="8" viewBox="0 0 10 8" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,l2="/projects/memory/assets/exitgame1-BZslv4aI.svg",G="/projects/memory/assets/back-to-game-button-Dy28tT7r.svg",d2="/projects/memory/assets/exit-game-button-CSFmJePI.svg",m2="/projects/memory/assets/Cards%205-DZnpmrpx.svg",u2="/projects/memory/assets/angular-card-CMiTHiGh.svg",p2="/projects/memory/assets/bootstrap-card-Rq83vZTa.svg",g2="/projects/memory/assets/css-card-Yna33ZIc.svg",C2="/projects/memory/assets/database-card-DZJGMO6r.svg",f2="/projects/memory/assets/django-card-zdDnWkPj.svg",_2="/projects/memory/assets/firebase-card-BGJGDkPQ.svg",h2="/projects/memory/assets/guthub-card-C0OAhCwn.svg",v2="/projects/memory/assets/html5-card-CuL2MCMe.svg",y2="/projects/memory/assets/js-card-vn5hBh96.svg",b2="/projects/memory/assets/node-card-Dum8zyHj.svg",w2="/projects/memory/assets/python-card-xA_4epsW.svg",S2="/projects/memory/assets/react-card-CIELOEMr.svg",E2="/projects/memory/assets/sass-card-DwnRYj6b.svg",L2="/projects/memory/assets/terminal-card-B7_Z2NcV.svg",O2="/projects/memory/assets/ts-card-BKPozS6g.svg",T2="/projects/memory/assets/vscode-card-fF042ORC.svg",B2="/projects/memory/assets/vue-card-BoB3VO2b.svg",O=[u2,p2,g2,C2,f2,_2,h2,v2,y2,b2,w2,S2,E2,L2,O2,T2,B2];function I2(e){const t=i2(e.theme),a=e.boardSize??"16",s=P2(a),n=A2(a),r=e.theme!=="foods",o=e.player==="orange"?" is-orange":" is-blue";return`
  ...
  `}function x2(){return N.replace(/fill="#2BB1FF"/gi,'fill="currentColor"').trim()}function $2(){return`
    <div class="game-screen__hud">
      <button
        id="game-exit-button"
  ...
  `}function A2(e){const t=Number.parseInt(e,10),a=Number.isFinite(t)&&t>0?t:16,s=Math.floor(a/2),n=R2(s);return F2([...n,...n]).map((o,c)=>`
    ...
    `).join("")}function R2(e){return Array.from({length:e},(t,a)=>O[a%O.length])}function F2(e){const t=[...e];for(let a=t.length-1;a>0;a-=1){const s=Math.floor(Math.random()*(a+1));[t[a],t[s]]=[t[s],t[a]]}return t}function P2(e){return e==="24"?"game-screen--board-24":e==="36"?"game-screen--board-36":"game-screen--board-16"}const j2="#game-exit-button",D2="[data-exit-modal]",H2="[data-exit-cancel]",N2="[data-exit-confirm]",G2=".game-screen",T="is-exit-modal-open",Z2=".game-card",q2="[data-current-player-marker]",u="flipped",p="is-matched",z2=700,V2=320;function U2(e){const t=l();e.innerHTML=I2(t),W2(e),Y2(e,t.player??"blue")}function W2(e){const t=e.querySelector(j2),a=e.querySelector(D2),s=e.querySelector(H2),n=e.querySelector(N2),r=e.querySelector(G2);if(!t||!a||!s||!n||!r)return;const o=()=>{a.hidden=!1,r.classList.add(T)},c=()=>{a.hidden=!0,r.classList.remove(T)};t.addEventListener("click",()=>{o()}),s.addEventListener("click",()=>{c()}),n.addEventListener("click",()=>{window.location.hash="#settings"})}function Y2(e,t){const a=Array.from(e.querySelectorAll(Z2));if(a.length===0)return;const s={currentPlayer:t,firstFlippedCard:null,secondFlippedCard:null,isTurnLocked:!1,scores:{blue:0,orange:0}};w(e,s),a.forEach(n=>{n.addEventListener("click",()=>{K2(e,a.length,s,n)})})}function K2(e,t,a,s){if(a.isTurnLocked||s.classList.contains(u)||s.classList.contains(p))return;if(C(s),!a.firstFlippedCard){a.firstFlippedCard=s;return}if(a.secondFlippedCard=s,a.isTurnLocked=!0,X2(a.firstFlippedCard,a.secondFlippedCard)){J2(e,t,a);return}window.setTimeout(()=>{a.firstFlippedCard&&a.firstFlippedCard.classList.contains(u)&&C(a.firstFlippedCard),a.secondFlippedCard&&a.secondFlippedCard.classList.contains(u)&&C(a.secondFlippedCard),a.currentPlayer=a.currentPlayer==="blue"?"orange":"blue",b(a),w(e,a)},z2)}function C(e){e.classList.toggle(u)}function X2(e,t){const a=e.dataset.cardIcon,s=t.dataset.cardIcon;return!!(a&&s&&a===s)}function J2(e,t,a){const s=a.firstFlippedCard,n=a.secondFlippedCard;if(!s||!n){b(a);return}s.classList.add(p),n.classList.add(p),s.disabled=!0,n.disabled=!0,a.scores[a.currentPlayer]+=1,b(a),w(e,a),e.querySelectorAll(`.${p}`).length===t&&window.setTimeout(()=>{K({blueScore:a.scores.blue,orangeScore:a.scores.orange}),window.location.hash="#game-over"},V2)}function b(e){e.firstFlippedCard=null,e.secondFlippedCard=null,e.isTurnLocked=!1}function w(e,t){B(e,"blue",t.scores.blue),B(e,"orange",t.scores.orange);const a=e.querySelector(q2);a&&a.classList.toggle("is-orange",t.currentPlayer==="orange")}function B(e,t,a){const s=e.querySelectorAll(`[data-score-player="${t}"]`);s.length!==0&&s.forEach(n=>{n.textContent=String(a)})}const Q2="/projects/memory/assets/Confetti-Ze9Uy3By.svg";function ee(e){const t=te(),a=se(e),s=ae(e,t);return`
    <main
  ...
  `}function te(){return N.replace(/fill="#2BB1FF"/gi,'fill="currentColor"').trim()}function ae(e,t){return`
  ...
  `}function Le(e){return F.map(t=>S("theme",t.value,t.label,e===t.value)).join("")}function Oe(e){return P.map(t=>S("player",t.value,t.label,e===t.value)).join("")}function Te(e){return j.map(t=>S("boardSize",t.value,t.label,e===t.value)).join("")}function S(e,t,a,s){const n=s?" is-selected":"",r=s?" is-visible":"",o=s?x:k,c=e==="theme"?` data-preview-theme="${t}"`:"";return`
  ...
  `}function Ie(e){return e?"Game theme":"Theme"}function ke(e){return e?e==="orange"?"Orange Player":"Blue Player":"Player"}function xe(e){return e?`Board-${e} Cards`:"Board size"}function $e(e){return`
    <button
