(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const o of n)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&a(r)}).observe(document,{childList:!0,subtree:!0});function s(n){const o={};return n.integrity&&(o.integrity=n.integrity),n.referrerPolicy&&(o.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?o.credentials="include":n.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function a(n){if(n.ep)return;n.ep=!0;const o=s(n);fetch(n.href,o)}})();const w=[{value:"code-vibes",label:"Code vibes theme"},{value:"foods",label:"Foods theme"}],S=[{value:"blue",label:"Blue"},{value:"orange",label:"Orange"}],L=[{value:"16",label:"16 cards"},{value:"24",label:"24 cards"},{value:"36",label:"36 cards"}];let i={boardSize:null,player:null,theme:null};function C(){return{...i}}function O(e){i={...i,theme:e}}function $(e){i={...i,player:e}}function k(e){i={...i,boardSize:e}}function h(){return!!(i.theme&&i.player&&i.boardSize)}function T(e){return w.some(t=>t.value===e)}function x(e){return S.some(t=>t.value===e)}function M(e){return L.some(t=>t.value===e)}const I="/projects/memory/assets/Code%20vibes%20theme_16-DnDZKwbK.svg",A="/projects/memory/assets/Code%20vibes%20theme_24-B6WV80WL.svg",R="/projects/memory/assets/Code%20vibes%20theme_36-DBGuI9rU.svg",P="/projects/memory/assets/Food_theme_16-C22FWGub.svg",Z="/projects/memory/assets/Food_theme_24-CMaMg8km.svg",H="/projects/memory/assets/Food_theme_36-DpVdfDWc.svg",z={"code-vibes":{16:I,24:A,36:R},foods:{16:P,24:Z,36:H}};function F(e){return`
    <main class="game-screen" aria-labelledby="game-title">
      <div class="game-screen__canvas">
        <img
          class="game-screen__board"
          src="${D(e.theme,e.boardSize)}"
          alt="Memory board"
        />

        <header class="game-screen__overlay">
          <h1 id="game-title">Game</h1>
          <p>${G(e.theme,e.player,e.boardSize)}</p>
          <button id="game-back-button" type="button">Settings</button>
        </header>
      </div>
    </main>
  `}function D(e,t){const s=e??"code-vibes",a=t??"16";return z[s][a]}function G(e,t,s){const a=e||"-",n=t||"-",o=s?`${s} cards`:"-";return`Theme: ${a} | Player: ${n} | Board: ${o}`}const U="#game-back-button";function q(e){e.innerHTML=F(C()),N(e)}function N(e){const t=e.querySelector(U);t&&t.addEventListener("click",()=>{window.location.hash="#settings"})}const j="/projects/memory/assets/stadia_controller-CcsXEKot.svg",V="/projects/memory/assets/play-button-CNXT5xaq.svg";function K(){return`
  ...
  `}function X(){return`
    ...
    >
      <img src="${V}" alt="" aria-hidden="true" />
    </button>
  `}function Y(){return`
    <img
    ...
    <main class="settings-screen" aria-labelledby="settings-title">
      <div class="settings-screen__canvas">
        <section class="settings-panel">
          ...
          ${l("Game themes",n2,u2(e.theme))}
          ${l("Choose player",a2,m2(e.player))}
          ${l("Board size",s2,d2(e.boardSize))}
        </section>

        <aside class="settings-preview">
          <img src="${i2}" alt="Game preview" />
        </aside>
  ...
  `}function u2(e){return w.map(t=>f("theme",t.value,t.label,e===t.value)).join("")}function m2(e){return S.map(t=>f("player",t.value,t.label,e===t.value)).join("")}function d2(e){return L.map(t=>f("boardSize",t.value,t.label,e===t.value)).join("")}function f(e,t,s,a){return`
    <li class="settings-option-item">
      <button
        class="settings-option${a?" is-selected":""}"
        type="button"
        data-group="${e}"
        data-value="${t}"
      >
        <img
          ...
          src="${a?v:y}"
          data-active-icon="${v}"
          data-inactive-icon="${y}"
          alt=""
          aria-hidden="true"
        />
        <span class="settings-option__label">${s}</span>
        <img
          class="settings-option__line${a?" is-visible":""}"
          src="${r2}"
          alt=""
          aria-hidden="true"
        />
  ...
  `}function u(e,t,s,a){const n=s?" is-selected":"",o=a?`<img
      ...
      src="${_}"
      data-separator-inactive="${_}"
      data-separator-active="${o2}"
      alt=""
      aria-hidden="true"
    />`:"";return`
  ...
  `}function h2(e){return e?"Game theme":"Theme"}function f2(e){return e?e==="orange"?"Orange Player":"Blue Player":"Player"}function p2(e){return e?`Board-${e} Cards`:"Board size"}function g2(e){return`
    <button
  ...
  `}const E=".settings-option",y2=".settings-option__line",v2=".settings-option__marker",_2=".settings-footer__separator",B="#start-game-button",m="is-refreshing";function b2(e){e.innerHTML=l2(C()),w2(e),A2(e)}function w2(e){e.querySelectorAll(E).forEach(s=>{s.addEventListener("click",()=>{S2(e,s.dataset.group,s.dataset.value)})})}function S2(e,t,s){!t||!s||(L2(t,s),E2(e,C()))}function L2(e,t){if(e==="theme"&&T(t)){O(t);return}if(e==="player"&&x(t)){$(t);return}e==="boardSize"&&M(t)&&k(t)}function E2(e,t){B2(e,t),$2(e,t),I2(e)}function B2(e,t){e.querySelectorAll(E).forEach(a=>{const n=O2(t,a.dataset.group,a.dataset.value);a.classList.toggle("is-selected",n),a.querySelector(y2)?.classList.toggle("is-visible",n);const r=a.querySelector(v2);if(!r)return;const c=n?r.dataset.activeIcon:r.dataset.inactiveIcon;c&&(r.src=c)})}function O2(e,t,s){return!t||!s?!1:t==="theme"?e.theme===s:t==="player"?e.player===s:t==="boardSize"?e.boardSize===s:!1}function $2(e,t){d(e,"theme",t.theme!==null,T2(t.theme)),d(e,"player",t.player!==null,x2(t.player)),d(e,"boardSize",t.boardSize!==null,M2(t.boardSize))}function d(e,t,s,a){const n=e.querySelector(`[data-summary-group="${t}"]`);if(!n)return;const o=n.classList.contains("is-selected");n.classList.toggle("is-selected",s);const r=n.querySelector(_2);if(r){const g=s?r.dataset.separatorActive:r.dataset.separatorInactive;g&&(r.src=g)}const c=n.querySelector(`[data-summary-text="${t}"]`);let p=!1;c&&c.textContent!==a&&(c.textContent=a,p=!0),(s&&!o||p)&&k2(n)}function k2(e){e.classList.remove(m),window.requestAnimationFrame(()=>{e.classList.add(m),window.setTimeout(()=>{e.classList.remove(m)},240)})}function T2(e){return e?"Game theme":"Theme"}function x2(e){return e?e==="orange"?"Orange Player":"Blue Player":"Player"}function M2(e){return e?`Board-${e} Cards`:"Board size"}function I2(e){const t=e.querySelector(B);if(!t)return;const s=h();t.classList.toggle("is-ready",s),t.disabled=!s}function A2(e){const t=e.querySelector(B);t&&t.addEventListener("click",()=>{h()&&(window.location.hash="#game")})}function R2(e){b(e),window.addEventListener("hashchange",()=>{b(e)})}function b(e){const t=Z2();if(t==="home"){Q(e);return}if(t==="settings"){b2(e);return}P2(e)}function P2(e){if(!h()){window.location.hash="#settings";return}q(e)}function Z2(){const e=window.location.hash.toLowerCase();return e==="#settings"?"settings":e==="#game"?"game":"home"}function H2(){const e=document.getElementById("app");e&&R2(e)}H2();
