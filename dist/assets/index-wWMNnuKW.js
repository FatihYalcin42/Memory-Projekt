(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const o of n)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&a(r)}).observe(document,{childList:!0,subtree:!0});function s(n){const o={};return n.integrity&&(o.integrity=n.integrity),n.referrerPolicy&&(o.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?o.credentials="include":n.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function a(n){if(n.ep)return;n.ep=!0;const o=s(n);fetch(n.href,o)}})();const g=[{value:"code-vibes",label:"Code vibes theme"},{value:"foods",label:"Foods theme"}],v=[{value:"blue",label:"Blue"},{value:"orange",label:"Orange"}],y=[{value:"16",label:"16 cards"},{value:"24",label:"24 cards"},{value:"36",label:"36 cards"}];let i={boardSize:null,player:null,theme:null};function l(){return{...i}}function P(e){i={...i,theme:e}}function R(e){i={...i,player:e}}function H(e){i={...i,boardSize:e}}function _(){return!!(i.theme&&i.player&&i.boardSize)}function k(e){return g.some(t=>t.value===e)}function Z(e){return v.some(t=>t.value===e)}function z(e){return y.some(t=>t.value===e)}const F="/projects/memory/assets/Code%20vibes%20theme_16-DnDZKwbK.svg",D="/projects/memory/assets/Code%20vibes%20theme_24-B6WV80WL.svg",U="/projects/memory/assets/Code%20vibes%20theme_36-DBGuI9rU.svg",q="/projects/memory/assets/Food_theme_16-C22FWGub.svg",N="/projects/memory/assets/Food_theme_24-CMaMg8km.svg",G="/projects/memory/assets/Food_theme_36-DpVdfDWc.svg",j="code-vibes",V="16",M={"code-vibes":{boardImages:{16:F,24:D,36:U},cssModifierClass:"game-screen--code-vibes"},foods:{boardImages:{16:q,24:N,36:G},cssModifierClass:"game-screen--foods"}};function x(e){return e??j}function K(e){return e??V}function W(e){return M[x(e)].cssModifierClass}function X(e,t){const s=x(e),a=K(t);return M[s].boardImages[a]}function Y(e){const t=W(e.theme),s=X(e.theme,e.boardSize);return`
  ...
  `}function J(e){const t=u(g,e.theme),s=u(v,e.player),a=u(y,e.boardSize);return`Theme: ${t} | Player: ${s} | Board: ${a}`}function u(e,t){if(!t)return"-";const s=e.find(a=>a.value===t);return s?s.label:"-"}const Q="#game-back-button";function e2(e){e.innerHTML=Y(l()),t2(e)}function t2(e){const t=e.querySelector(Q);t&&t.addEventListener("click",()=>{window.location.hash="#settings"})}const s2="/projects/memory/assets/stadia_controller-CcsXEKot.svg",n2="/projects/memory/assets/play-button-CNXT5xaq.svg";function a2(){return`
  ...
  `}function r2(){return`
    ...
    >
      <img src="${n2}" alt="" aria-hidden="true" />
    </button>
  `}function i2(){return`
    <img
    ...
    <main class="settings-screen" aria-labelledby="settings-title">
      <div class="settings-screen__canvas">
        <section class="settings-panel">
          ...
          ${C("Choose player",f2,_2(e.player))}
  ...
  `}function y2(e){return g.map(t=>w("theme",t.value,t.label,e===t.value)).join("")}function _2(e){return v.map(t=>w("player",t.value,t.label,e===t.value)).join("")}function w2(e){return y.map(t=>w("boardSize",t.value,t.label,e===t.value)).join("")}function w(e,t,s,a){const n=a?" is-selected":"",o=a?" is-visible":"",r=a?L:E,c=e==="theme"?` data-preview-theme="${t}"`:"";return`
  ...
  `}function b2(e,t){return`
    <div class="settings-footer__summary" aria-live="polite">
      <div class="settings-footer__fields">
        ${f("theme",S2(e.theme),e.theme!==null,!0)}
        ${f("player",E2(e.player),e.player!==null,!0)}
        ${f("boardSize",L2(e.boardSize),e.boardSize!==null,!1)}
      </div>
      ${O2(t)}
    </div>
  `}function f(e,t,s,a){const n=s?" is-selected":"",o=a?`<img
      class="settings-footer__separator"
      src="${O}"
      data-separator-inactive="${O}"
  ...
  `}const I=".settings-option",B2='.settings-option[data-group="theme"]',T2=".settings-option__line",$2=".settings-option__marker",k2=".settings-footer__separator",M2=".settings-preview__image",A="#start-game-button",h="is-refreshing";function x2(e){e.innerHTML=v2(l()),I2(e),H2(e),j2(e),m(e,l().theme)}function I2(e){e.querySelectorAll(I).forEach(s=>{s.addEventListener("click",()=>{A2(e,s.dataset.group,s.dataset.value)})})}function A2(e,t,s){!t||!s||(P2(t,s),R2(e,l()))}function P2(e,t){if(e==="theme"&&k(t)){P(t);return}if(e==="player"&&Z(t)){R(t);return}e==="boardSize"&&z(t)&&H(t)}function R2(e,t){Z2(e,t),F2(e,t),G2(e),m(e,t.theme)}function H2(e){e.querySelectorAll(B2).forEach(s=>{s.addEventListener("mouseenter",()=>{T(e,s.dataset.previewTheme)}),s.addEventListener("mouseleave",()=>{m(e,l().theme)}),s.addEventListener("focus",()=>{T(e,s.dataset.previewTheme)}),s.addEventListener("blur",()=>{m(e,l().theme)})})}function T(e,t){!t||!k(t)||m(e,t)}function m(e,t){const s=e.querySelector(M2);if(!s)return;const a=t==="foods"?s.dataset.previewFoods:s.dataset.previewCodeVibes||s.dataset.previewDefault;a&&(s.src=a)}function Z2(e,t){e.querySelectorAll(I).forEach(a=>{const n=z2(t,a.dataset.group,a.dataset.value);a.classList.toggle("is-selected",n),a.querySelector(T2)?.classList.toggle("is-visible",n);const r=a.querySelector($2);if(!r)return;const c=n?r.dataset.activeIcon:r.dataset.inactiveIcon;c&&(r.src=c)})}function z2(e,t,s){return!t||!s?!1:t==="theme"?e.theme===s:t==="player"?e.player===s:t==="boardSize"?e.boardSize===s:!1}function F2(e,t){p(e,"theme",t.theme!==null,U2(t.theme)),p(e,"player",t.player!==null,q2(t.player)),p(e,"boardSize",t.boardSize!==null,N2(t.boardSize))}function p(e,t,s,a){const n=e.querySelector(`[data-summary-group="${t}"]`);if(!n)return;const o=n.classList.contains("is-selected");n.classList.toggle("is-selected",s);const r=n.querySelector(k2);if(r){const S=s?r.dataset.separatorActive:r.dataset.separatorInactive;S&&(r.src=S)}const c=n.querySelector(`[data-summary-text="${t}"]`);let b=!1;c&&c.textContent!==a&&(c.textContent=a,b=!0),(s&&!o||b)&&D2(n)}function D2(e){e.classList.remove(h),window.requestAnimationFrame(()=>{e.classList.add(h),window.setTimeout(()=>{e.classList.remove(h)},240)})}function U2(e){return e?"Game theme":"Theme"}function q2(e){return e?e==="orange"?"Orange Player":"Blue Player":"Player"}function N2(e){return e?`Board-${e} Cards`:"Board size"}function G2(e){const t=e.querySelector(A);if(!t)return;const s=_();t.classList.toggle("is-ready",s),t.disabled=!s}function j2(e){const t=e.querySelector(A);t&&t.addEventListener("click",()=>{_()&&(window.location.hash="#game")})}function V2(e){$(e),window.addEventListener("hashchange",()=>{$(e)})}function $(e){const t=W2();if(t==="home"){l2(e);return}if(t==="settings"){x2(e);return}K2(e)}function K2(e){if(!_()){window.location.hash="#settings";return}e2(e)}function W2(){const e=window.location.hash.toLowerCase();return e==="#settings"?"settings":e==="#game"?"game":"home"}function X2(){const e=document.getElementById("app");e&&V2(e)}X2();
