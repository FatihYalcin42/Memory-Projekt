(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))r(a);new MutationObserver(a=>{for(const n of a)if(n.type==="childList")for(const o of n.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&r(o)}).observe(document,{childList:!0,subtree:!0});function s(a){const n={};return a.integrity&&(n.integrity=a.integrity),a.referrerPolicy&&(n.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?n.credentials="include":a.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function r(a){if(a.ep)return;a.ep=!0;const n=s(a);fetch(a.href,n)}})();const x=[{value:"code-vibes",label:"Code vibes theme"},{value:"foods",label:"Foods theme"}],F=[{value:"blue",label:"Blue"},{value:"orange",label:"Orange"}],P=[{value:"16",label:"16 cards"},{value:"24",label:"24 cards"},{value:"36",label:"36 cards"}];let i={boardSize:null,player:null,theme:null};function l(){return{...i}}function Z(e){i={...i,theme:e}}function G(e){i={...i,player:e}}function z(e){i={...i,boardSize:e}}function C(){return!!(i.theme&&i.player&&i.boardSize)}function j(e){return x.some(t=>t.value===e)}function q(e){return F.some(t=>t.value===e)}function V(e){return P.some(t=>t.value===e)}let d=null;function U(e){d={...e}}function W(){return d?{...d}:null}function Y(){return d!==null}function K(){d=null}const X="/projects/memory/assets/Code%20vibes%20theme_16-DnDZKwbK.svg",J="/projects/memory/assets/Code%20vibes%20theme_24-B6WV80WL.svg",Q="/projects/memory/assets/Code%20vibes%20theme_36-DBGuI9rU.svg",e2="/projects/memory/assets/Food_theme_16-C22FWGub.svg",t2="/projects/memory/assets/Food_theme_24-CMaMg8km.svg",s2="/projects/memory/assets/Food_theme_36-DpVdfDWc.svg",r2="code-vibes",a2={"code-vibes":{boardImages:{16:X,24:J,36:Q},cssModifierClass:"game-screen--code-vibes"},foods:{boardImages:{16:e2,24:t2,36:s2},cssModifierClass:"game-screen--foods"}};function n2(e){return e??r2}function o2(e){return a2[n2(e)].cssModifierClass}const H=`<svg width="10" height="8" viewBox="0 0 10 8" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,c2="/projects/memory/assets/exitgame1-BZslv4aI.svg",i2="/projects/memory/assets/Cards%205-DZnpmrpx.svg",l2="/projects/memory/assets/angular-card-CMiTHiGh.svg",d2="/projects/memory/assets/bootstrap-card-Rq83vZTa.svg",m2="/projects/memory/assets/css-card-Yna33ZIc.svg",u2="/projects/memory/assets/database-card-DZJGMO6r.svg",p2="/projects/memory/assets/django-card-zdDnWkPj.svg",C2="/projects/memory/assets/firebase-card-BGJGDkPQ.svg",g2="/projects/memory/assets/guthub-card-C0OAhCwn.svg",f2="/projects/memory/assets/html5-card-CuL2MCMe.svg",h2="/projects/memory/assets/js-card-vn5hBh96.svg",v2="/projects/memory/assets/node-card-Dum8zyHj.svg",_2="/projects/memory/assets/python-card-xA_4epsW.svg",y2="/projects/memory/assets/react-card-CIELOEMr.svg",b2="/projects/memory/assets/sass-card-DwnRYj6b.svg",w2="/projects/memory/assets/terminal-card-B7_Z2NcV.svg",S2="/projects/memory/assets/ts-card-BKPozS6g.svg",E2="/projects/memory/assets/vscode-card-fF042ORC.svg",L2="/projects/memory/assets/vue-card-BoB3VO2b.svg",B=[l2,d2,m2,u2,p2,C2,g2,f2,h2,v2,_2,y2,b2,w2,S2,E2,L2];function B2(e){const t=o2(e.theme),s=e.boardSize??"16",r=A2(s),a=T2(s),n=e.theme!=="foods",o=e.player==="orange"?" is-orange":" is-blue";return`
  ...
  `}function T2(e){const t=Number.parseInt(e,10),s=Number.isFinite(t)&&t>0?t:16,r=Math.floor(s/2),a=M2(r);return k2([...a,...a]).map((o,c)=>`
      <button
        class="game-card"
        type="button"
        data-card-index="${c}"
    ...
    `).join("")}function M2(e){return Array.from({length:e},(t,s)=>B[s%B.length])}function k2(e){const t=[...e];for(let s=t.length-1;s>0;s-=1){const r=Math.floor(Math.random()*(s+1));[t[s],t[r]]=[t[r],t[s]]}return t}function A2(e){return e==="24"?"game-screen--board-24":e==="36"?"game-screen--board-36":"game-screen--board-16"}const R2="#game-exit-button",x2=".game-card",F2="[data-current-player-marker]",u="flipped",p="is-matched",P2=700,j2=320;function H2(e){const t=l();e.innerHTML=B2(t),N2(e),D2(e,t.player??"blue")}function N2(e){const t=e.querySelector(R2);t&&t.addEventListener("click",()=>{window.location.hash="#settings"})}function D2(e,t){const s=Array.from(e.querySelectorAll(x2));if(s.length===0)return;const r={currentPlayer:t,firstFlippedCard:null,secondFlippedCard:null,isTurnLocked:!1,scores:{blue:0,orange:0}};w(e,r),s.forEach(a=>{a.addEventListener("click",()=>{Z2(e,s.length,r,a)})})}function Z2(e,t,s,r){if(s.isTurnLocked||r.classList.contains(u)||r.classList.contains(p))return;if(g(r),!s.firstFlippedCard){s.firstFlippedCard=r;return}if(s.secondFlippedCard=r,s.isTurnLocked=!0,G2(s.firstFlippedCard,s.secondFlippedCard)){z2(e,t,s);return}window.setTimeout(()=>{s.firstFlippedCard&&s.firstFlippedCard.classList.contains(u)&&g(s.firstFlippedCard),s.secondFlippedCard&&s.secondFlippedCard.classList.contains(u)&&g(s.secondFlippedCard),s.currentPlayer=s.currentPlayer==="blue"?"orange":"blue",b(s),w(e,s)},P2)}function g(e){e.classList.toggle(u)}function G2(e,t){const s=e.dataset.cardIcon,r=t.dataset.cardIcon;return!!(s&&r&&s===r)}function z2(e,t,s){const r=s.firstFlippedCard,a=s.secondFlippedCard;if(!r||!a){b(s);return}r.classList.add(p),a.classList.add(p),r.disabled=!0,a.disabled=!0,s.scores[s.currentPlayer]+=1,b(s),w(e,s),e.querySelectorAll(`.${p}`).length===t&&window.setTimeout(()=>{U({blueScore:s.scores.blue,orangeScore:s.scores.orange}),window.location.hash="#game-over"},j2)}function b(e){e.firstFlippedCard=null,e.secondFlippedCard=null,e.isTurnLocked=!1}function w(e,t){I(e,"blue",t.scores.blue),I(e,"orange",t.scores.orange);const s=e.querySelector(F2);s&&s.classList.toggle("is-orange",t.currentPlayer==="orange")}function I(e,t,s){const r=e.querySelectorAll(`[data-score-player="${t}"]`);r.length!==0&&r.forEach(a=>{a.textContent=String(s)})}const q2="/projects/memory/assets/Confetti-Ze9Uy3By.svg";function V2(e){const t=U2(),s=Y2(e),r=W2(e,t);return`
    <main
  ...
  `}function U2(){return H.replace(/fill="#2BB1FF"/gi,'fill="currentColor"').trim()}function W2(e,t){return`
  ...
  `}function Y2(e){return e.blueScore>e.orangeScore?{className:"game-over-screen__winner-player--blue",label:"BLUE PLAYER"}:e.orangeScore>e.blueScore?{className:"game-over-screen__winner-player--orange",label:"ORANGE PLAYER"}:{className:"game-over-screen__winner-player--draw",label:"DRAW"}}const K2=2200,X2="[data-game-over-screen]",J2="is-winner-visible";function Q2(e){const t=W();if(!t){window.location.hash="#game";return}e.innerHTML=V2(t);const s=e.querySelector(X2);s&&window.setTimeout(()=>{!e.isConnected||window.location.hash!=="#game-over"||s.classList.add(J2)},K2)}const ee="/projects/memory/assets/stadia_controller-CcsXEKot.svg",O="/projects/memory/assets/play-button-CNXT5xaq.svg";function te(){return`
    ...
    <main class="settings-screen" aria-labelledby="settings-title">
      <div class="settings-screen__canvas">
        <section class="settings-panel">
          ...
          ${h("Game themes",de,fe(e.theme))}
          ${h("Choose player",me,he(e.player))}
          ${h("Board size",le,ve(e.boardSize))}
        </section>
  ...
  `}function fe(e){return x.map(t=>S("theme",t.value,t.label,e===t.value)).join("")}function he(e){return F.map(t=>S("player",t.value,t.label,e===t.value)).join("")}function ve(e){return P.map(t=>S("boardSize",t.value,t.label,e===t.value)).join("")}function S(e,t,s,r){const a=r?" is-selected":"",n=r?" is-visible":"",o=r?T:$,c=e==="theme"?` data-preview-theme="${t}"`:"";return`
    <li class="settings-option-item">
      <button
        class="settings-option${a}"
        type="button"
        data-group="${e}"
        data-value="${t}"
        ${c}
  ...
  `}function _e(e,t){return`
    <div class="settings-footer__summary" aria-live="polite">
      <div class="settings-footer__fields">
        ${v("theme",ye(e.theme),e.theme!==null,!0)}
        ${v("player",be(e.player),e.player!==null,!0)}
        ${v("boardSize",we(e.boardSize),e.boardSize!==null,!1)}
      </div>
      ${Se(t)}
    </div>
  `}function v(e,t,s,r){const a=s?" is-selected":"",n=r?`<img
      class="settings-footer__separator"
      src="${M}"
      data-separator-inactive="${M}"
      data-separator-active="${ue}"
      alt=""
      aria-hidden="true"
    />`:"";return`
    <div class="settings-footer__item${a}" data-summary-group="${e}">
      <span class="settings-footer__text" data-summary-text="${e}">${t}</span>
      ${n}
    </div>
  `}function ye(e){return e?"Game theme":"Theme"}function be(e){return e?e==="orange"?"Orange Player":"Blue Player":"Player"}function we(e){return e?`Board-${e} Cards`:"Board size"}function Se(e){return`
    <button
  ...
  `}const N=".settings-option",Ee='.settings-option[data-group="theme"]',Le=".settings-option__line",Be=".settings-option__marker",Ie=".settings-footer__separator",Oe=".settings-preview__image",D="#start-game-button",_="is-refreshing";function $e(e){e.innerHTML=ge(l()),Te(e),Re(e),Ge(e),m(e,l().theme)}function Te(e){e.querySelectorAll(N).forEach(s=>{s.addEventListener("click",()=>{Me(e,s.dataset.group,s.dataset.value)})})}function Me(e,t,s){!t||!s||(ke(t,s),Ae(e,l()))}function ke(e,t){if(e==="theme"&&j(t)){Z(t);return}if(e==="player"&&q(t)){G(t);return}e==="boardSize"&&V(t)&&z(t)}function Ae(e,t){xe(e,t),Pe(e,t),Ze(e),m(e,t.theme)}function Re(e){e.querySelectorAll(Ee).forEach(s=>{s.addEventListener("mouseenter",()=>{A(e,s.dataset.previewTheme)}),s.addEventListener("mouseleave",()=>{m(e,l().theme)}),s.addEventListener("focus",()=>{A(e,s.dataset.previewTheme)}),s.addEventListener("blur",()=>{m(e,l().theme)})})}function A(e,t){!t||!j(t)||m(e,t)}function m(e,t){const s=e.querySelector(Oe);if(!s)return;const r=t==="foods"?s.dataset.previewFoods:s.dataset.previewCodeVibes||s.dataset.previewDefault;r&&(s.src=r)}function xe(e,t){e.querySelectorAll(N).forEach(r=>{const a=Fe(t,r.dataset.group,r.dataset.value);r.classList.toggle("is-selected",a),r.querySelector(Le)?.classList.toggle("is-visible",a);const o=r.querySelector(Be);if(!o)return;const c=a?o.dataset.activeIcon:o.dataset.inactiveIcon;c&&(o.src=c)})}function Fe(e,t,s){return!t||!s?!1:t==="theme"?e.theme===s:t==="player"?e.player===s:t==="boardSize"?e.boardSize===s:!1}function Pe(e,t){y(e,"theme",t.theme!==null,He(t.theme)),y(e,"player",t.player!==null,Ne(t.player)),y(e,"boardSize",t.boardSize!==null,De(t.boardSize))}function y(e,t,s,r){const a=e.querySelector(`[data-summary-group="${t}"]`);if(!a)return;const n=a.classList.contains("is-selected");a.classList.toggle("is-selected",s);const o=a.querySelector(Ie);if(o){const L=s?o.dataset.separatorActive:o.dataset.separatorInactive;L&&(o.src=L)}const c=a.querySelector(`[data-summary-text="${t}"]`);let E=!1;c&&c.textContent!==r&&(c.textContent=r,E=!0),(s&&!n||E)&&je(a)}function je(e){e.classList.remove(_),window.requestAnimationFrame(()=>{e.classList.add(_),window.setTimeout(()=>{e.classList.remove(_)},240)})}function He(e){return e?"Game theme":"Theme"}function Ne(e){return e?e==="orange"?"Orange Player":"Blue Player":"Player"}function De(e){return e?`Board-${e} Cards`:"Board size"}function Ze(e){const t=e.querySelector(D);if(!t)return;const s=C();t.classList.toggle("is-ready",s),t.disabled=!s}function Ge(e){const t=e.querySelector(D);t&&t.addEventListener("click",()=>{C()&&(K(),window.location.hash="#game")})}function ze(e){R(e),window.addEventListener("hashchange",()=>{R(e)})}function R(e){const t=Ue();if(t==="home"){oe(e);return}if(t==="settings"){$e(e);return}if(t==="game-over"){Ve(e);return}qe(e)}function qe(e){if(!C()){window.location.hash="#settings";return}H2(e)}function Ve(e){if(!C()){window.location.hash="#settings";return}if(!Y()){window.location.hash="#game";return}Q2(e)}function Ue(){const e=window.location.hash.toLowerCase();return e==="#settings"?"settings":e==="#game"?"game":e==="#game-over"?"game-over":"home"}function We(){const e=document.getElementById("app");e&&ze(e)}We();
